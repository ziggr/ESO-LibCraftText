LANG_DB = {
  [  1] = {
          ...
          ,   de  = "Gift des Lebensentzugs IX^n"
          ,   fr  = "Poison de drain de Santé IX^m"
          ,   es  = "veneno de absorción de vida IX^m"
...
, [  2] = {
          ...
          ,   de  = "Gift der Lebensschändung IX^n"
          ,   fr  = "Poison de ravage de Santé IX^m"
          ,   es  = "Veneno de daño a la salud IX^m"
...
, [  3] = {
          ...
          ,   de  = "Gift des Magickaentzugs IX^n"
          ,   fr  = "Poison de drain de Magie IX^m"
...
, [  4] = {
          ...
          ,   de  = "Gift der Magickaschändung IX^n"
          ,   fr  = "Poison de ravage de Magie IX^m"
...
, [  5] = {
          ...
          ,   de  = "Gift des Ausdauerentzugs IX^n"
          ,   fr  = "Poison de drain de Vigueur IX^m"
...
, [  6] = {
          ...
          ,   de  = "Gift der Ausdauerschändung IX^n"
          ,   fr  = "Poison de ravage de Vigueur IX^m"
...
, [  7] = {
          ...
          ,   de  = "Gift des Schutzentzugs IX^n"
          ,   fr  = "Poison de drain de Protection IX^m"
...
, [  8] = {
          ...
          ,   de  = "Gift des Durchdringens IX^n"
          ,   fr  = "Poison de brèche IX^m"
...
, [  9] = {
          ...
          ,   de  = "Gift des Entschlossenheitsentzugs IX^n"
          ,   fr  = "Poison de drain de Résolution IX^m"
...
, [ 10] = {
          ...
          ,   de  = "Gift des Zertrümmerns IX^n"
          ,   fr  = "Poison de fracture IX^m"
...
, [ 11] = {
          ...
          ,   de  = "Gift des Zaubereientzugs IX^n"
          ,   fr  = "Poison de drain de Sorcellerie IX^m"
...
, [ 12] = {
          ...
          ,   de  = "Gift der Feigheit IX^n"
          ,   fr  = "Poison de lâcheté IX^m"
...
, [ 13] = {
          ...
          ,   de  = "Gift des Brutalitätsentzugs IX^n"
          ,   fr  = "Poison de drain de Brutalité IX^m"
...
, [ 14] = {
          ...
          ,   de  = "Gift der Verstümmelung IX^n"
          ,   fr  = "Poison de Mutilation IX^m"
...
, [ 15] = {
          ...
          ,   de  = "Gift des Prophetieentzugs IX^n"
          ,   fr  = "Poison de drain de Prophécie IX^m"
...
, [ 16] = {
          ...
          ,   de  = "Gift der Ungewissheit IX^n"
          ,   fr  = "Poison d'Incertitude IX^m"
...
, [ 17] = {
          ...
          ,   de  = "Gift des Wildheitentzugs IX^n"
          ,   fr  = "Poison de drain de Sauvagerie IX^m"
...
, [ 18] = {
          ...
          ,   de  = "Gift der Enervierung IX^n"
          ,   fr  = "Poison d'Affaiblissement IX^m"
...
, [ 19] = {
          ...
          ,   de  = "Gift des Fliehenden IX^n"
          ,   fr  = "Poison du monte-en-l'air IX^m"
...
, [ 20] = {
          ...
          ,   de  = "Gift des Festsetzens IX^n"
          ,   fr  = "Poison d'Entrave IX^m"
...
, [ 21] = {
          ...
          ,   de  = "Gift des Schleichentzugs IX^n"
          ,   fr  = "Poison de drain de Furtivité IX^m"
...
, [ 22] = {
          ...
          ,   de  = "Gift des Auffallens IX^n"
          ,   fr  = "Poison révélateur IX^m"
...
, [ 23] = {
          ...
          ,   de  = "Gift des Tempoentzugs IX^n"
          ,   fr  = "Poison de drain de vitesse IX^m"
...
, [ 24] = {
          ...
          ,   de  = "Gift der Hinderung IX^n"
          ,   fr  = "Poison ralentissant IX^m"
...
, [ 25] = {
          ...
          ,   de  = "Gift der Schutzumkehrung IX^n"
          ,   fr  = "Poison inverseur de protection IX^m"
...
, [ 26] = {
          ...
          ,   de  = "Gift der Verwundbarkeit IX^n"
          ,   fr  = "Poison de vulnérabilité IX^m"
...
, [ 27] = {
          ...
          ,   de  = "langsam wirkendes Gift des Lebensentzugs IX^n"
          ,   fr  = "Poison de drain graduel de Santé IX^m"
...
, [ 28] = {
          ...
          ,   de  = "langsam wirkendes Gift der Lebensverwüstung IX^n"
          ,   fr  = "Poison de ravage graduel de Santé IX^m"
...
, [ 29] = {
          ...
          ,   de  = "Gift des Vitalitätsentzugs IX^n"
          ,   fr  = "Poison de drain de Vitalité IX^m"
...
, [ 30] = {
          ...
          ,   de  = "Gift der Schändung IX^n"
          ,   fr  = "Poison profanateur IX^m"
...
, [ 31] = {
          ...
          ,   de  = "Essenz des Lebens^f"
          ,   fr  = "essence de Santé^f"
          ,   es  = "esencia de salud^f"
          ,   it  = "health"
          ,   ja  = "体力 のエキス"
          }
, [ 32] = {
          ...
          ,   de  = "Essenz der Lebensverwüstung^f"
          ,   fr  = "essence de ravage de Santé^f"
          ,   es  = "esencia de reducción de salud^f"
          ,   it  = "Ravage Health"
          ,   ja  = "体力減少 のエキス"
          }
, [ 33] = {
          ...
          ,   de  = "Essenz der Magicka^f"
          ,   fr  = "essence de Magie^f"
          ,   es  = "esencia de magia^f"
          ,   it  = "Magicka"
          ,   ja  = "マジカ のエキス"
          }
, [ 34] = {
          ...
          ,   de  = "Essenz der Magickaverwüstung^f"
          ,   fr  = "essence de ravage de Magie^f"
          ,   es  = "esencia de reducción de magia^f"
          ,   it  = "Ravage Magicka"
          ,   ja  = "マジカ減少 のエキス"
          }
, [ 35] = {
          ...
          ,   de  = "Essenz der Ausdauer^f"
          ,   fr  = "essence de Vigueur^f"
          ,   es  = "esencia de aguante^f"
          ,   it  = "stamina"
          ,   ja  = "スタミナ のエキス"
          }
, [ 36] = {
          ...
          ,   de  = "Essenz der Ausdauerverwüstung^f"
          ,   fr  = "essence de ravage de Vigueur^f"
          ,   es  = "esencia de reducción de aguante^f"
          ,   it  = "Ravage Stamina"
          ,   ja  = "スタミナ減少 のエキス"
          }
, [ 37] = {
          ...
          ,   de  = "Essenz des Zauberschutzes^f"
          ,   fr  = "essence de protection contre les sorts^f"
          ,   es  = "esencia de's protección mágica^F"
          ,   it  = "Spell Protection"
          ,   ja  = "呪文防御 のエキス"
          }
, [ 38] = {
          ...
          ,   de  = "Essenz der Zauberschutzverwüstung^f"
          ,   fr  = "essence de ravage de protection contre les sorts^f"
          ,   es  = "Estrago de protección mágica esencia de^f"
...
, [ 39] = {
          ...
          ,   en  = "Essence of Armor"
          ,   de  = "Essenz der Rüstung^f"
          ,   fr  = "essence de armure^f"
          ,   es  = "esencia de's armadura^F"
          ,   it  = "Armor"
          ,   ja  = "防具 のエキス"
          }
, [ 40] = {
          ...
          ,   de  = "Essenz der Rüstungsverwüstung^f"
          ,   fr  = "essence de ravage d'armure^f"
          ,   es  = "esencia de estrago de armadura^f"
          ,   it  = "Ravage Armor"
          ,   ja  = "鎧破損度 のエキス"
          }
, [ 41] = {
          ...
          ,   de  = "Essenz der Magiekraft^f"
          ,   fr  = "essence de puissance de sort^f"
          ,   es  = "esencia de potencia de hechizo^f"
          ,   it  = "Spell Power"
          ,   ja  = "呪文攻撃力 のエキス"
          }
, [ 42] = {
          ...
          ,   de  = "Essenz der Feigheit^f"
          ,   fr  = "essence de couardise^f"
          ,   es  = "esencia de cobardía^f"
          ,   it  = "Cowardice"
          ,   ja  = "臆病 のエキス"
          }
, [ 43] = {
          ...
          ,   de  = "Essenz der Waffenkraft^f"
          ,   fr  = "essence de puissance d'arme^f"
          ,   es  = "esencia de poder del arma^f"
          ,   it  = "Weapon Power"
          ,   ja  = "武器攻撃力 のエキス"
          }
, [ 44] = {
          ...
          ,   en  = "Essence of Maim"
          ,   de  = "Essenz des Verkrüppelns^f"
          ,   fr  = "essence de mutilation^f"
          ,   es  = "esencia de mutilación^f"
          ,   it  = "Maim"
          ,   ja  = "不自由 のエキス"
          }
, [ 45] = {
          ...
          ,   de  = "Essenz der kritischen Magietreffer^f"
          ,   fr  = "essence de critique des sorts^f"
          ,   es  = "esencia de crítico mágico^f"
          ,   it  = "Spell Critical"
          ,   ja  = "呪文クリティカル のエキス"
          }
, [ 46] = {
          ...
          ,   de  = "Essenz der Ungewissheit^f"
          ,   fr  = "essence de incertitude^f"
          ,   es  = "esencia de incertidumbre^f"
          ,   it  = "Uncertainty"
          ,   ja  = "不信 のエキス"
          }
, [ 47] = {
          ...
          ,   de  = "Essenz der kritischen Waffentreffer^f"
          ,   fr  = "essence de critique d'arme^f"
          ,   es  = "esencia de crítico físico^f"
          ,   it  = "Weapon Crit"
          ,   ja  = "武器クリティカル のエキス"
          }
, [ 48] = {
          ...
          ,   de  = "Essenz der Schwäche^f"
          ,   fr  = "essence de affaiblissement^f"
          ,   es  = "enervación esencia de^f"
          ,   it  = "Enervation"
          ,   ja  = "弱体化 のエキス"
          }
, [ 49] = {
          ...
          ,   de  = "Essenz der Unbeweglichkeit^f"
          ,   fr  = "essence de Immuabilité^f"
          ,   es  = "esencia de inmovilidad^f"
          ,   it  = "Immovability"
          ,   ja  = "不動性 のエキス"
          }
, [ 50] = {
          ...
          ,   de  = "Essenz des Einfangens^f"
          ,   fr  = "essence de capture^f"
          ,   es  = "esencia de captura^f"
          ,   it  = "Entrapment"
          ,   ja  = "罠 のエキス"
          }
, [ 51] = {
          ...
          ,   de  = "Essenz der Detektion^f"
          ,   fr  = "essence de détection^f"
          ,   es  = "esencia de detección^f"
          ,   it  = "Detection"
          ,   ja  = "探知 のエキス"
          }
, [ 52] = {
          ...
          ,   de  = "Essenz der Unsichtbarkeit^f"
          ,   fr  = "essence de Invisibilité^f"
          ,   es  = "esencia de invisibilidad^f"
          ,   it  = "Invisibility"
          ,   ja  = "透明化 のエキス"
          }
, [ 53] = {
          ...
          ,   en  = "Essence of Speed"
          ,   de  = "Essenz des Tempos^f"
          ,   fr  = "essence de vitesse^f"
          ,   es  = "esencia de velocidad^f"
          ,   it  = "Speed"
          ,   ja  = "加速 のエキス"
          }
, [ 54] = {
          ...
          ,   de  = "Essenz des Einschränkens^f"
          ,   fr  = "essence de entravant^f"
          ,   es  = "estorbo esencia de^f"
          ,   it  = "Hindering"
          ,   ja  = "妨害 のエキス"
          }
, [ 55] = {
          ...
          ,   de  = "Essenz des Schutzes^f"
          ,   fr  = "essence de Protection^f"
          ,   es  = "esencia de Protección^f"
          ,   it  = "Protection"
          ,   ja  = "防御 のエキス"
          }
, [ 56] = {
          ...
          ,   de  = "Essenz der Verwundbarkeit^f"
          ,   fr  = "essence de vulnérabilité^f"
          ,   es  = "esencia de vulnerabilidad^f"
          ,   it  = "Vulnerability"
          ,   ja  = "脆弱 のエキス"
          }
, [ 57] = {
          ...
          ,   de  = "Essenz des beständigen Lebens^f"
          ,   fr  = "essence de Santé pérenne^f"
          ,   es  = "esencia de Salud prolongada^f"
          ,   it  = "Lingering Health"
          ,   ja  = "体力継続 のエキス"
          }
, [ 58] = {
          ...
          ,   de  = "Essenz der schleichenden Lebensverwüstung^f"
          ,   fr  = "essence de Ravage de Santé rampante^f"
          ,   es  = "Estrago progresivo de salud esencia de^f"
...
, [ 59] = {
          ...
          ,   de  = "Essenz der Vitalität^f"
          ,   fr  = "essence de vitalité^f"
          ,   es  = "esencia de vitalidad^f"
          ,   it  = "Vitality"
          ,   ja  = "生命力 のエキス"
          }
, [ 60] = {
          ...
          ,   de  = "Essenz der Schändung^f"
          ,   fr  = "essence de Avilissement^f"
          ,   es  = "esencia de Profanación^f"
          ,   it  = "Defile"
          ,   ja  = "汚染 のエキス"
          }
, [ 61] = {
