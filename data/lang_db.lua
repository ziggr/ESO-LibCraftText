LANG_DB = {
  [  1] = {
              key = "$ALCHEMY_MASTER_POISON_01"
          ,   en  = "Drain Health Poison IX"
          ,   de  = "Gift des Lebensentzugs IX"
          ,   fr  = "Poison de drain de Santé IX"
          ,   es  = "veneno de absorción de vida IX"
          ,   it  = "Drain Health Poison"
          ,   ja  = "体力吸収の毒 9"
          }
, [  2] = {
              key = "$ALCHEMY_MASTER_POISON_02"
          ,   en  = "Damage Health Poison IX"
          ,   de  = "Gift der Lebensschändung IX"
          ,   fr  = "Poison de ravage de Santé IX"
          ,   es  = "Veneno de daño a la salud IX"
          ,   it  = "Damage Health Poison"
          ,   ja  = "体力減少の毒 9"
          }
, [  3] = {
              key = "$ALCHEMY_MASTER_POISON_03"
          ,   en  = "Drain Magicka Poison IX"
          ,   de  = "Gift des Magickaentzugs IX"
          ,   fr  = "Poison de drain de Magie IX"
          ,   es  = "Veneno de absorción de magia IX"
          ,   it  = "Drain Magicka Poison"
          ,   ja  = "マジカ吸収の毒 9"
          }
, [  4] = {
              key = "$ALCHEMY_MASTER_POISON_04"
          ,   en  = "Damage Magicka Poison IX"
          ,   de  = "Gift der Magickaschändung IX"
          ,   fr  = "Poison de ravage de Magie IX"
          ,   es  = "Veneno de daño a la magia IX"
          ,   it  = "Damage Magicka Poison"
          ,   ja  = "マジカ減少の毒 9"
          }
, [  5] = {
              key = "$ALCHEMY_MASTER_POISON_05"
          ,   en  = "Drain Stamina Poison IX"
          ,   de  = "Gift des Ausdauerentzugs IX"
          ,   fr  = "Poison de drain de Vigueur IX"
          ,   es  = "Veneno de absorción de aguante IX"
          ,   it  = "Drain Stamina Poison"
          ,   ja  = "スタミナ吸収の毒 9"
          }
, [  6] = {
              key = "$ALCHEMY_MASTER_POISON_06"
          ,   en  = "Damage Stamina Poison IX"
          ,   de  = "Gift der Ausdauerschändung IX"
          ,   fr  = "Poison de ravage de Vigueur IX"
          ,   es  = "Veneno de daño al aguante IX"
          ,   it  = "Damage Stamina Poison"
          ,   ja  = "スタミナ減少の毒 9"
          }
, [  7] = {
              key = "$ALCHEMY_MASTER_POISON_07"
          ,   en  = "Ward-Draining Poison IX"
          ,   de  = "Gift des Schutzentzugs IX"
          ,   fr  = "Poison de drain de Protection IX"
          ,   es  = "Veneno de absorción del custodio IX"
          ,   it  = "Ward-Draining Poison"
          ,   ru  = "Яд ослабления защиты IX"
          ,   ja  = "結界吸収の毒 9"
          }
, [  8] = {
              key = "$ALCHEMY_MASTER_POISON_08"
          ,   en  = "Breaching Poison IX"
          ,   de  = "Gift des Durchdringens IX"
          ,   fr  = "Poison de brèche IX"
          ,   es  = "Veneno perforador IX"
          ,   it  = "Breaching Poison"
          ,   ja  = "侵害の毒 9"
          }
, [  9] = {
              key = "$ALCHEMY_MASTER_POISON_09"
          ,   en  = "Resolve-Draining Poison IX"
          ,   de  = "Gift des Entschlossenheitsentzugs IX"
          ,   fr  = "Poison de drain de Résolution IX"
          ,   es  = "Veneno de absorción resolutorio IX"
          ,   it  = "Resolve-Draining Poison"
          ,   ja  = "強固吸収の毒 9"
          }
, [ 10] = {
              key = "$ALCHEMY_MASTER_POISON_10"
          ,   en  = "Fracturing Poison IX"
          ,   de  = "Gift des Zertrümmerns IX"
          ,   fr  = "Poison de fracture IX"
          ,   es  = "Veneno fracturador IX"
          ,   it  = "Fracturing Poison"
          ,   ja  = "破砕の毒 9"
          }
, [ 11] = {
              key = "$ALCHEMY_MASTER_POISON_11"
          ,   en  = "Sorcery-Draining Poison IX"
          ,   de  = "Gift des Zaubereientzugs IX"
          ,   fr  = "Poison de drain de Sorcellerie IX"
          ,   es  = "Veneno de absorción del hechicero IX"
          ,   it  = "Sorcery-Draining Poison"
          ,   ja  = "魔術吸収の毒 9"
          }
, [ 12] = {
              key = "$ALCHEMY_MASTER_POISON_12"
          ,   en  = "Cowardice Poison IX"
          ,   de  = "Gift der Feigheit IX"
          ,   fr  = "Poison de lâcheté IX"
          ,   es  = "Veneno de cobardía IX"
          ,   it  = "Cowardice Poison"
          ,   ja  = "臆病の毒 9"
          }
, [ 13] = {
              key = "$ALCHEMY_MASTER_POISON_13"
          ,   en  = "Brutality-Draining Poison IX"
          ,   de  = "Gift des Brutalitätsentzugs IX"
          ,   fr  = "Poison de drain de Brutalité IX"
          ,   es  = "Veneno de absorción de brutalidad IX"
          ,   it  = "Brutality-Draining Poison"
          ,   ja  = "残忍吸収の毒 9"
          }
, [ 14] = {
              key = "$ALCHEMY_MASTER_POISON_14"
          ,   en  = "Maiming Poison IX"
          ,   de  = "Gift der Verstümmelung IX"
          ,   fr  = "Poison de Mutilation IX"
          ,   es  = "Veneno de mutilación IX"
          ,   it  = "Maiming Poison"
          ,   ja  = "不自由の毒 9"
          }
, [ 15] = {
              key = "$ALCHEMY_MASTER_POISON_15"
          ,   en  = "Prophecy-Draining Poison IX"
          ,   de  = "Gift des Prophetieentzugs IX"
          ,   fr  = "Poison de drain de Prophécie IX"
          ,   es  = "Veneno de absorción profética IX"
          ,   it  = "Prophecy-Draining Poison"
          ,   ja  = "予言吸収の毒 9"
          }
, [ 16] = {
              key = "$ALCHEMY_MASTER_POISON_16"
          ,   en  = "Uncertainty Poison IX"
          ,   de  = "Gift der Ungewissheit IX"
          ,   fr  = "Poison d'Incertitude IX"
          ,   es  = "Veneno de incertidumbre IX"
          ,   it  = "Uncertainty Poison"
          ,   ja  = "不信の毒 9"
          }
, [ 17] = {
              key = "$ALCHEMY_MASTER_POISON_17"
          ,   en  = "Savagery-Draining Poison IX"
          ,   de  = "Gift des Wildheitentzugs IX"
          ,   fr  = "Poison de drain de Sauvagerie IX"
          ,   es  = "Veneno de absorción de salvajismo IX"
          ,   it  = "Savagery-Draining Poison"
          ,   ja  = "獰猛吸収の毒 9"
          }
, [ 18] = {
              key = "$ALCHEMY_MASTER_POISON_18"
          ,   en  = "Enervating Poison IX"
          ,   de  = "Gift der Enervierung IX"
          ,   fr  = "Poison d'Affaiblissement IX"
          ,   es  = "Veneno enervante IX"
          ,   it  = "Enervating Poison"
          ,   ja  = "弱体化の毒 9"
          }
, [ 19] = {
              key = "$ALCHEMY_MASTER_POISON_19"
          ,   en  = "Escapist's Poison IX"
          ,   de  = "Gift des Fliehenden IX"
          ,   fr  = "Poison du monte-en-l'air IX"
          ,   es  = "Veneno del escapista IX"
          ,   it  = "Escapist's Poison"
          ,   ja  = "逃避者の毒 9"
          }
, [ 20] = {
              key = "$ALCHEMY_MASTER_POISON_20"
          ,   en  = "Entrapping Poison IX"
          ,   de  = "Gift des Festsetzens IX"
          ,   fr  = "Poison d'Entrave IX"
          ,   es  = "Veneno enredador IX"
          ,   it  = "Entrapping Poison"
          ,   ja  = "罠の毒 9"
          }
, [ 21] = {
              key = "$ALCHEMY_MASTER_POISON_21"
          ,   en  = "Stealth-Draining Poison IX"
          ,   de  = "Gift des Schleichentzugs IX"
          ,   fr  = "Poison de drain de Furtivité IX"
          ,   es  = "Veneno de absorción de sigilo IX"
          ,   it  = "Stealth-Draining Poison"
          ,   ja  = "ステルス吸収の毒 9"
          }
, [ 22] = {
              key = "$ALCHEMY_MASTER_POISON_22"
          ,   en  = "Conspicuous Poison IX"
          ,   de  = "Gift des Auffallens IX"
          ,   fr  = "Poison révélateur IX"
          ,   es  = "Revealing Poison IX"
          ,   it  = "Conspicuous Poison"
          ,   ja  = "露見の毒 9"
          }
, [ 23] = {
              key = "$ALCHEMY_MASTER_POISON_23"
          ,   en  = "Speed-Draining Poison IX"
          ,   de  = "Gift des Tempoentzugs IX"
          ,   fr  = "Poison de drain de vitesse IX"
          ,   es  = "Veneno de absorción de velocidad IX"
          ,   it  = "Speed-Draining Poison"
          ,   ja  = "速度吸収の毒 9"
          }
, [ 24] = {
              key = "$ALCHEMY_MASTER_POISON_24"
          ,   en  = "Hindering Poison IX"
          ,   de  = "Gift der Hinderung IX"
          ,   fr  = "Poison ralentissant IX"
          ,   es  = "Slowing Poison IX"
          ,   it  = "Hindering Poison"
          ,   ja  = "妨害の毒 9"
          }
, [ 25] = {
              key = "$ALCHEMY_MASTER_POISON_25"
          ,   en  = "Protection-Reversing Poison IX"
          ,   de  = "Gift der Schutzumkehrung IX"
          ,   fr  = "Poison inverseur de protection IX"
          ,   es  = "Veneno anti-protección IX"
          ,   it  = "Protection-Reversing Poison"
          ,   ja  = "防御逆転の毒 9"
          }
, [ 26] = {
              key = "$ALCHEMY_MASTER_POISON_26"
          ,   en  = "Vulnerability Poison IX"
          ,   de  = "Gift der Verwundbarkeit IX"
          ,   fr  = "Poison de vulnérabilité IX"
          ,   es  = "Veneno de vulnerabilidad IX"
          ,   it  = "Vulnerability Poison"
          ,   ja  = "脆弱の毒 9"
          }
, [ 27] = {
              key = "$ALCHEMY_MASTER_POISON_27"
          ,   en  = "Gradual Health Drain Poison IX"
          ,   de  = "langsam wirkendes Gift des Lebensentzugs IX"
          ,   fr  = "Poison de drain graduel de Santé IX"
          ,   es  = "Veneno de absorción progresiva de salud IX"
          ,   it  = "Gradual Health Drain Poison"
          ,   ja  = "体力吸収継続の毒 9"
          }
, [ 28] = {
              key = "$ALCHEMY_MASTER_POISON_28"
          ,   en  = "Gradual Ravage Health Poison IX"
          ,   de  = "langsam wirkendes Gift der Lebensverwüstung IX"
          ,   fr  = "Poison de ravage graduel de Santé IX"
          ,   es  = "Veneno de daño progresivo de salud IX"
          ,   it  = "Gradual Ravage Health Poison"
          ,   ja  = "体力減少継続の毒 9"
          }
, [ 29] = {
              key = "$ALCHEMY_MASTER_POISON_29"
          ,   en  = "Vitality-Draining Poison IX"
          ,   de  = "Gift des Vitalitätsentzugs IX"
          ,   fr  = "Poison de drain de Vitalité IX"
          ,   es  = "veneno de absorción de vitalidad^z IX^z"
          ,   it  = "Vitality-Draining Poison"
          ,   ja  = "生命力吸収の毒 9"
          }
, [ 30] = {
              key = "$ALCHEMY_MASTER_POISON_30"
          ,   en  = "Defiling Poison IX"
          ,   de  = "Gift der Schändung IX"
          ,   fr  = "Poison profanateur IX"
          ,   es  = "Veneno marchitador IX"
          ,   it  = "Defiling Poison"
          ,   ja  = "汚染の毒 9"
          }
, [ 31] = {
              key = "$ALCHEMY_MASTER_POTION_01"
          ,   en  = "Essence of health"
...
, [ 32] = {
              key = "$ALCHEMY_MASTER_POTION_02"
          ,   en  = "Essence of Ravage Health"
          ,   de  = "Essenz der Lebensverwüstung"
          ,   fr  = "essence de ravage de Santé"
          ,   es  = "esencia de reducción de salud"
          ,   it  = "Ravage Health"
          ,   ja  = "体力減少 のエキス"
          }
, [ 33] = {
              key = "$ALCHEMY_MASTER_POTION_03"
          ,   en  = "Essence of Magicka"
          ,   de  = "Essenz der Magicka"
          ,   fr  = "essence de Magie"
          ,   es  = "esencia de magia"
          ,   it  = "Magicka"
          ,   ja  = "マジカ のエキス"
...
, [ 34] = {
              key = "$ALCHEMY_MASTER_POTION_04"
          ,   en  = "Essence of Ravage Magicka"
          ,   de  = "Essenz der Magickaverwüstung"
          ,   fr  = "essence de ravage de Magie"
          ,   es  = "esencia de reducción de magia"
          ,   it  = "Ravage Magicka"
          ,   ja  = "マジカ減少 のエキス"
          }
, [ 35] = {
              key = "$ALCHEMY_MASTER_POTION_05"
          ,   en  = "Essence of stamina"
          ,   de  = "Essenz der Ausdauer"
          ,   fr  = "essence de Vigueur"
          ,   es  = "esencia de aguante"
          ,   it  = "stamina"
          ,   ja  = "スタミナ のエキス"
          }
, [ 36] = {
              key = "$ALCHEMY_MASTER_POTION_06"
          ,   en  = "Essence of Ravage Stamina"
          ,   de  = "Essenz der Ausdauerverwüstung"
          ,   fr  = "essence de ravage de Vigueur"
          ,   es  = "esencia de reducción de aguante"
          ,   it  = "Ravage Stamina"
          ,   ja  = "スタミナ減少 のエキス"
          }
, [ 37] = {
              key = "$ALCHEMY_MASTER_POTION_07"
          ,   en  = "Essence of Spell Protection"
          ,   de  = "Essenz des Zauberschutzes"
          ,   fr  = "essence de protection contre les sorts"
          ,   es  = "esencia de's protección mágica"
          ,   it  = "Spell Protection"
          ,   ja  = "呪文防御 のエキス"
          }
, [ 38] = {
              key = "$ALCHEMY_MASTER_POTION_08"
          ,   en  = "Essence of Ravage Spell Protection"
          ,   de  = "Essenz der Zauberschutzverwüstung"
          ,   fr  = "essence de ravage de protection contre les sorts"
          ,   es  = "Estrago de protección mágica esencia de"
          ,   it  = "Ravage Spell Protection"
          ,   ja  = "呪文防御減少 のエキス"
          }
, [ 39] = {
              key = "$ALCHEMY_MASTER_POTION_09"
          ,   en  = "Essence of Armor"
          ,   de  = "Essenz der Rüstung"
          ,   fr  = "essence d’armure"
          ,   es  = "esencia de's armadura"
          ,   it  = "Armor"
          ,   ja  = "防具 のエキス"
          }
, [ 40] = {
              key = "$ALCHEMY_MASTER_POTION_10"
          ,   en  = "Essence of Ravage Armor"
          ,   de  = "Essenz der Rüstungsverwüstung"
          ,   fr  = "essence de ravage d'armure"
          ,   es  = "esencia de estrago de armadura"
          ,   it  = "Ravage Armor"
          ,   ja  = "鎧破損度 のエキス"
          }
, [ 41] = {
              key = "$ALCHEMY_MASTER_POTION_11"
          ,   en  = "Essence of Spell Power"
          ,   de  = "Essenz der Magiekraft"
          ,   fr  = "essence de puissance de sort"
          ,   es  = "esencia de potencia de hechizo"
          ,   it  = "Spell Power"
          ,   ja  = "呪文攻撃力 のエキス"
          }
, [ 42] = {
              key = "$ALCHEMY_MASTER_POTION_12"
          ,   en  = "Essence of Cowardice"
          ,   de  = "Essenz der Feigheit"
          ,   fr  = "essence de couardise"
          ,   es  = "esencia de cobardía"
          ,   it  = "Cowardice"
          ,   ja  = "臆病 のエキス"
          }
, [ 43] = {
              key = "$ALCHEMY_MASTER_POTION_13"
          ,   en  = "Essence of Weapon Power"
          ,   de  = "Essenz der Waffenkraft"
          ,   fr  = "essence de puissance d'arme"
          ,   es  = "esencia de poder del arma"
          ,   it  = "Weapon Power"
          ,   ja  = "武器攻撃力 のエキス"
          }
, [ 44] = {
              key = "$ALCHEMY_MASTER_POTION_14"
          ,   en  = "Essence of Maim"
          ,   de  = "Essenz des Verkrüppelns"
          ,   fr  = "essence de mutilation"
          ,   es  = "esencia de mutilación"
          ,   it  = "Maim"
          ,   ja  = "不自由 のエキス"
          }
, [ 45] = {
              key = "$ALCHEMY_MASTER_POTION_15"
          ,   en  = "Essence of Spell Critical"
          ,   de  = "Essenz der kritischen Magietreffer"
          ,   fr  = "essence de critique des sorts"
          ,   es  = "esencia de crítico mágico"
          ,   it  = "Spell Critical"
          ,   ja  = "呪文クリティカル のエキス"
          }
, [ 46] = {
              key = "$ALCHEMY_MASTER_POTION_16"
          ,   en  = "Essence of Uncertainty"
          ,   de  = "Essenz der Ungewissheit"
          ,   fr  = "essence d’incertitude"
          ,   es  = "esencia de incertidumbre"
          ,   it  = "Uncertainty"
          ,   ja  = "不信 のエキス"
          }
, [ 47] = {
              key = "$ALCHEMY_MASTER_POTION_17"
          ,   en  = "Essence of Weapon Crit"
          ,   de  = "Essenz der kritischen Waffentreffer"
          ,   fr  = "essence de critique d'arme"
          ,   es  = "esencia de crítico físico"
          ,   it  = "Weapon Crit"
          ,   ja  = "武器クリティカル のエキス"
          }
, [ 48] = {
              key = "$ALCHEMY_MASTER_POTION_18"
          ,   en  = "Essence of Enervation"
          ,   de  = "Essenz der Schwäche"
          ,   fr  = "essence d’affaiblissement"
          ,   es  = "enervación esencia de"
          ,   it  = "Enervation"
          ,   ja  = "弱体化 のエキス"
          }
, [ 49] = {
              key = "$ALCHEMY_MASTER_POTION_19"
          ,   en  = "Essence of Immovability"
          ,   de  = "Essenz der Unbeweglichkeit"
          ,   fr  = "essence d’Immuabilité"
          ,   es  = "esencia de inmovilidad"
          ,   it  = "Immovability"
          ,   ja  = "不動性 のエキス"
          }
, [ 50] = {
              key = "$ALCHEMY_MASTER_POTION_20"
          ,   en  = "Essence of Entrapment"
          ,   de  = "Essenz des Einfangens"
          ,   fr  = "essence de capture"
          ,   es  = "esencia de captura"
          ,   it  = "Entrapment"
          ,   ja  = "罠 のエキス"
          }
, [ 51] = {
              key = "$ALCHEMY_MASTER_POTION_21"
          ,   en  = "Essence of Detection"
          ,   de  = "Essenz der Detektion"
          ,   fr  = "essence de détection"
          ,   es  = "esencia de detección"
          ,   it  = "Detection"
          ,   ja  = "探知 のエキス"
          }
, [ 52] = {
              key = "$ALCHEMY_MASTER_POTION_22"
          ,   en  = "Essence of Invisibility"
          ,   de  = "Essenz der Unsichtbarkeit"
          ,   fr  = "essence d’Invisibilité"
          ,   es  = "esencia de invisibilidad"
          ,   it  = "Invisibility"
          ,   ja  = "透明化 のエキス"
          }
, [ 53] = {
              key = "$ALCHEMY_MASTER_POTION_23"
          ,   en  = "Essence of Speed"
          ,   de  = "Essenz des Tempos"
          ,   fr  = "essence de vitesse"
          ,   es  = "esencia de velocidad"
          ,   it  = "Speed"
          ,   ja  = "加速 のエキス"
          }
, [ 54] = {
              key = "$ALCHEMY_MASTER_POTION_24"
          ,   en  = "Essence of Hindering"
          ,   de  = "Essenz des Einschränkens"
          ,   fr  = "essence d’entravant"
          ,   es  = "estorbo esencia de"
          ,   it  = "Hindering"
          ,   ja  = "妨害 のエキス"
          }
, [ 55] = {
              key = "$ALCHEMY_MASTER_POTION_25"
          ,   en  = "Essence of Protection"
          ,   de  = "Essenz des Schutzes"
          ,   fr  = "essence de Protection"
          ,   es  = "esencia de Protección"
          ,   it  = "Protection"
          ,   ja  = "防御 のエキス"
          }
, [ 56] = {
              key = "$ALCHEMY_MASTER_POTION_26"
          ,   en  = "Essence of Vulnerability"
          ,   de  = "Essenz der Verwundbarkeit"
          ,   fr  = "essence de vulnérabilité"
          ,   es  = "esencia de vulnerabilidad"
          ,   it  = "Vulnerability"
          ,   ja  = "脆弱 のエキス"
          }
, [ 57] = {
              key = "$ALCHEMY_MASTER_POTION_27"
          ,   en  = "Essence of Lingering Health"
          ,   de  = "Essenz des beständigen Lebens"
          ,   fr  = "essence de Santé pérenne"
          ,   es  = "esencia de Salud prolongada"
          ,   it  = "Lingering Health"
          ,   ja  = "体力継続 のエキス"
          }
, [ 58] = {
              key = "$ALCHEMY_MASTER_POTION_28"
          ,   en  = "Essence of Creeping Ravage Health"
          ,   de  = "Essenz der schleichenden Lebensverwüstung"
          ,   fr  = "essence de Ravage de Santé rampante"
          ,   es  = "Estrago progresivo de salud esencia de"
          ,   it  = "Creeping Ravage Health"
          ,   ja  = "体力減少継続 のエキス"
          }
, [ 59] = {
              key = "$ALCHEMY_MASTER_POTION_29"
          ,   en  = "Essence of Vitality"
          ,   de  = "Essenz der Vitalität"
          ,   fr  = "essence de vitalité"
          ,   es  = "esencia de vitalidad"
          ,   it  = "Vitality"
          ,   ja  = "生命力 のエキス"
          }
, [ 60] = {
              key = "$ALCHEMY_MASTER_POTION_30"
          ,   en  = "Essence of Defile"
          ,   de  = "Essenz der Schändung"
          ,   fr  = "essence d’Avilissement"
          ,   es  = "esencia de Profanación"
          ,   it  = "Defile"
          ,   ja  = "汚染 のエキス"
          }
, [ 61] = {
              key = "$ALCHEMY_POISON_HEALTH"
          ,   en  = "drain health"
          ,   de  = "lebensentzugs"
          ,   fr  = "drain de santé"
...
, [ 63] = {
              key = "$ALCHEMY_POISON_RAVAGE_HEALTH"
          ,   en  = "damage health"
          ,   de  = "lebensschändung"
          ,   fr  = "ravage de santé"
          ,   es  = "daño a la salud"
...
, [ 64] = {
              key = "$ALCHEMY_POISON_RAVAGE_HEALTH_B"
          ,   en  = "damage health"
          ,   de  = "lebensschändung"
          ,   fr  = "Dégâts de Santé"
          ,   es  = "daño a la salud"
...
, [ 65] = {
              key = "$ALCHEMY_POISON_RAVAGE_MAGICKA"
          ,   en  = "damage magicka"
          ,   de  = "magickaschändung"
          ,   fr  = "ravage de magie"
          ,   es  = "daño a la magia"
...
, [ 66] = {
              key = "$ALCHEMY_POISON_RAVAGE_MAGICKA_B"
          ,   en  = "ravage magicka"
          ,   de  = "magickaverwüstung"
          ,   fr  = "Dégâts de Magie"
          ,   es  = "reducción de magia"
          ,   ja  = "マジカ減少"
          }
, [ 67] = {
              key = "$ALCHEMY_POISON_RAVAGE_STAMINA"
          ,   en  = "damage stamina"
          ,   de  = "ausdauerschändung"
          ,   fr  = "ravage de vigueur"
          ,   es  = "daño al aguante"
          ,   ja  = "スタミナ減少"
          }
, [ 68] = {
              key = "$ALCHEMY_POISON_RAVAGE_STAMINA_B"
          ,   en  = "damage stamina"
          ,   de  = "ausdauerschändung"
          ,   fr  = "Dégâts de Vigueur"
          ,   es  = "daño al aguante"
          ,   ja  = "スタミナ減少"
          }
, [ 69] = {
              key = "$ALCHEMY_POISON_STAMINA"
          ,   en  = "drain stamina"
          ,   de  = "ausdauerentzugs"
          ,   fr  = "drain de vigueur"
...
, [ 72] = {
              key = "$ALCHEMY_POTION_RAVAGE_HEALTH"
          ,   en  = "ravage health"
          ,   de  = "lebensverwüstung"
          ,   fr  = "ravage de santé"
          ,   es  = "reducción de salud"
          ,   ja  = "体力減少"
          }
, [ 73] = {
              key = "$ALCHEMY_POTION_RAVAGE_MAGICKA"
          ,   en  = "ravage magicka"
          ,   de  = "magickaverwüstung"
          ,   fr  = "ravage de magie"
          ,   es  = "reducción de magia"
...
, [ 74] = {
              key = "$ALCHEMY_POTION_RAVAGE_STAMINA"
          ,   en  = "ravage stamina"
          ,   de  = "ausdauerverwüstung"
          ,   fr  = "ravage de vigueur"
          ,   es  = "reducción de aguante"
          ,   ja  = "スタミナ減少"
          }
, [ 75] = {
              key = "$ALCHEMY_POTION_STAMINA"
          ,   en  = "stamina"
          ,   de  = "ausdauer"
          ,   fr  = "vigueur"
          ,   es  = "aguante"
...
, [ 76] = {
              key = "$ALCHEMY_SOLVENT_POISON_1"
          ,   en  = "i"
          ,   it  = "Drain Health Poison"
          ,   ja  = "1"
          }
, [ 77] = {
              key = "$ALCHEMY_SOLVENT_POISON_2"
          ,   en  = "ii"
          ,   it  = "Drain Health Poison"
          ,   ja  = "2"
          }
, [ 78] = {
              key = "$ALCHEMY_SOLVENT_POISON_3"
          ,   en  = "iii"
          ,   it  = "Drain Health Poison"
          ,   ja  = "3"
          }
, [ 79] = {
              key = "$ALCHEMY_SOLVENT_POISON_4"
          ,   en  = "iv"
          ,   it  = "Drain Health Poison"
          ,   ja  = "4"
          }
, [ 80] = {
              key = "$ALCHEMY_SOLVENT_POISON_5"
          ,   en  = "v"
          ,   it  = "Drain Health Poison"
          ,   ja  = "5"
          }
, [ 81] = {
              key = "$ALCHEMY_SOLVENT_POISON_6"
          ,   en  = "vi"
          ,   it  = "Drain Health Poison"
          ,   ja  = "6"
          }
, [ 82] = {
              key = "$ALCHEMY_SOLVENT_POISON_7"
          ,   en  = "vii"
          ,   it  = "Drain Health Poison"
          ,   ja  = "7"
          }
, [ 83] = {
              key = "$ALCHEMY_SOLVENT_POISON_8"
          ,   en  = "viii"
          ,   it  = "Drain Health Poison"
          ,   ja  = "8"
          }
, [ 84] = {
              key = "$ALCHEMY_SOLVENT_POISON_9"
          ,   en  = "ix"
          ,   it  = "Drain Health Poison"
          ,   ja  = "9"
          }
, [ 85] = {
              key = "$ALCHEMY_SOLVENT_POTION_1"
          ,   en  = "sip"
          ,   de  = "schlückchen"
          ,   fr  = "gorgée"
          ,   es  = "sorbo"
...
, [ 95] = {
              key = "$ALCHEMY_TRAIT_01"
          ,   en  = "Restore Health"
          ,   de  = "Leben wiederherstellen"
          ,   fr  = "Rend de la Santé"
          ,   es  = "Restauración de salud"
          ,   ru  = "Восстановление здоровья"
          ,   ja  = "体力回復"
          }
, [ 96] = {
              key = "$ALCHEMY_TRAIT_02"
          ,   en  = "Ravage Health"
          ,   de  = "Lebensverwüstung"
          ,   fr  = "Réduit la Santé"
          ,   es  = "Reducción de salud"
...
, [ 97] = {
              key = "$ALCHEMY_TRAIT_03"
          ,   en  = "Restore Magicka"
          ,   de  = "Magicka wiederherstellen"
          ,   fr  = "Rend de la Magie"
          ,   es  = "Restauración de magia"
          ,   ru  = "Восстановление магии"
          ,   ja  = "マジカ回復"
          }
, [ 98] = {
              key = "$ALCHEMY_TRAIT_04"
          ,   en  = "Ravage Magicka"
          ,   de  = "Magickaverwüstung"
          ,   fr  = "Réduit la Magie"
          ,   es  = "Reducción de magia"
...
, [ 99] = {
              key = "$ALCHEMY_TRAIT_05"
          ,   en  = "Restore Stamina"
          ,   de  = "Ausdauer wiederherstellen"
          ,   fr  = "Rend de la Vigueur"
          ,   es  = "Restauración de aguante"
          ,   ru  = "Восстановление запаса сил"
          ,   ja  = "スタミナ回復"
          }
, [100] = {
              key = "$ALCHEMY_TRAIT_06"
          ,   en  = "Ravage Stamina"
          ,   de  = "Ausdauerverwüstung"
          ,   fr  = "Ravage de Vigueur"
          ,   es  = "Reducción de aguante"
...
, [101] = {
              key = "$ALCHEMY_TRAIT_07"
          ,   en  = "Increase Spell Resist"
          ,   de  = "Erhöht Magieresistenz"
          ,   fr  = "Augmente la résistance aux sorts"
          ,   es  = "Aumento de resistencia mágica"
          ,   ru  = "Увеличение защиты от магии"
          ,   ja  = "呪文耐性増大"
          }
, [102] = {
              key = "$ALCHEMY_TRAIT_08"
          ,   en  = "Breach"
          ,   de  = "Bruch"
          ,   fr  = "Brèche"
          ,   es  = "La Grieta"
...
, [103] = {
              key = "$ALCHEMY_TRAIT_09"
          ,   en  = "Increase Armor"
          ,   de  = "Erhöht Rüstung"
          ,   fr  = "Augmente l'armure"
          ,   es  = "Aumento de armadura"
          ,   ru  = "Увеличение брони"
          ,   ja  = "防御力増大"
          }
, [104] = {
              key = "$ALCHEMY_TRAIT_10"
          ,   en  = "Fracture"
          ,   de  = "Fraktur"
          ,   ru  = "Перелом"
          ,   ja  = "破砕"
...
, [105] = {
              key = "$ALCHEMY_TRAIT_11"
          ,   en  = "Increase Spell Power"
          ,   de  = "Erhöht Magiekraft"
          ,   fr  = "Augmente la puissance des sorts"
          ,   es  = "Aumento de poder mágico"
          ,   ru  = "Увеличение силы заклинаний"
          ,   ja  = "呪文攻撃力上昇"
          }
, [106] = {
              key = "$ALCHEMY_TRAIT_12"
          ,   en  = "Cowardice"
          ,   de  = "Feigheit"
          ,   fr  = "Couardise"
          ,   es  = "Cobardía"
...
, [107] = {
              key = "$ALCHEMY_TRAIT_13"
          ,   en  = "Increase Weapon Power"
          ,   de  = "Erhöht Waffenkraft"
          ,   fr  = "Augmente la puissance de l'arme"
          ,   es  = "Aumento del poder físico"
          ,   ru  = "Увеличение силы оружия"
          ,   ja  = "武器攻撃力上昇"
          }
, [108] = {
              key = "$ALCHEMY_TRAIT_14"
          ,   en  = "Maim"
          ,   de  = "Verkrüppeln"
          ,   fr  = "Mutilation"
          ,   es  = "Mutilación"
...
, [109] = {
              key = "$ALCHEMY_TRAIT_15"
          ,   en  = "Spell Critical"
          ,   de  = "Kritische Magietreffer"
          ,   fr  = "Critique de sorts"
          ,   es  = "Crítico mágico"
          ,   ru  = "Критический урон заклинаниями"
          ,   ja  = "呪文クリティカル"
          }
, [110] = {
              key = "$ALCHEMY_TRAIT_16"
          ,   en  = "Uncertainty"
          ,   de  = "Ungewissheit"
          ,   fr  = "Incertitude"
          ,   es  = "Incertidumbre"
...
, [111] = {
              key = "$ALCHEMY_TRAIT_17"
          ,   en  = "Weapon Critical"
          ,   de  = "Kritische Waffentreffer"
          ,   fr  = "Critique d'armes"
          ,   es  = "Crítico físico"
          ,   ru  = "Критический урон оружием"
          ,   ja  = "武器クリティカル"
          }
, [112] = {
              key = "$ALCHEMY_TRAIT_18"
          ,   en  = "Enervation"
          ,   de  = "Schwäche"
          ,   fr  = "Affaiblissement"
          ,   es  = "Debilitación"
...
, [121] = {
              key = "$ALCHEMY_TRAIT_27"
          ,   en  = "Lingering Health"
          ,   de  = "Beständige Heilung"
          ,   fr  = "Santé persistante"
          ,   es  = "Salud prolongada"
          ,   ru  = "Длительное исцеление"
          ,   ja  = "体力継続"
          }
, [122] = {
              key = "$ALCHEMY_TRAIT_28"
          ,   en  = "Gradual Ravage Health"
          ,   de  = "Langsame Lebensverwüstung"
          ,   fr  = "Ravage de Santé graduel"
          ,   es  = "Reducción de salud insidioso"
          ,   ru  = "Постепенное опустош. здоровья"
          ,   ja  = "体力漸減"
          }
, [123] = {
              key = "$ALCHEMY_TRAIT_29"
          ,   en  = "Vitality"
          ,   de  = "Vitalität"
          ,   fr  = "Vitalité"
          ,   es  = "Vitalidad"
...
, [128] = {
              key = "$DAILY_COND_AL_01_01"
          ,   en  = "Craft Sip of Health"
...
, [129] = {
              key = "$DAILY_COND_AL_01_02"
          ,   en  = "Acquire Blessed Thistle"
          ,   de  = "Besorgt etwas Benediktenkraut"
          ,   fr  = "Acquérez un chardon béni"
          ,   es  = "Adquiere cardo bendito"
          ,   it  = "Acquire blessed thistle"
          ,   ru  = "Раздобыть — благословенный чертополох"
          ,   ja  = "聖なるシッスルを手に入れる"
          }
, [130] = {
              key = "$DAILY_COND_AL_01_03"
          ,   en  = "Craft Sip of Magicka"
          ,   de  = "Stellt Schlückchen der Magicka her"
          ,   fr  = "Préparez une gorgée de Magie"
          ,   es  = "Prepara un sorbo de magia"
          ,   ja  = "マジカの雫を生産する"
          }
, [131] = {
              key = "$DAILY_COND_AL_01_04"
          ,   en  = "Acquire Wormwood"
          ,   de  = "Beschafft Wermut"
          ,   fr  = "Acquérez de l'absinthe"
          ,   es  = "Adquiere artemisia"
          ,   ru  = "Добыть полынь"
          ,   ja  = "ニガヨモギを手に入れる"
          }
, [132] = {
              key = "$DAILY_COND_AL_01_05"
          ,   en  = "Craft Sip of Stamina"
          ,   de  = "Stellt Schlückchen der Ausdauer her"
          ,   fr  = "Préparez une gorgée de Vigueur"
          ,   es  = "Prepara un sorbo de aguante"
          ,   ja  = "スタミナの雫を生産する"
          }
, [133] = {
              key = "$DAILY_COND_AL_01_06"
          ,   en  = "Acquire Corn Flower"
          ,   de  = "Besorgt eine Kornblume"
          ,   fr  = "Acquérez un bleuet"
          ,   es  = "Adquiere aciano"
          ,   it  = "Acquire corn flower"
          ,   ru  = "Раздобыть — василек"
          ,   ja  = "コーンフラワーを手に入れる"
          }
, [134] = {
              key = "$DAILY_COND_AL_01_07"
          ,   en  = "Craft Sip of Ravage Stamina"
          ,   de  = "Stellt Schlückchen der Ausdauerverwüstung her"
          ,   fr  = "Fabriquez une gorgée de ravage de Vigueur"
          ,   es  = "Prepara un sorbo de reducción de aguante"
          ,   ja  = "スタミナ減少の雫を生産する"
          }
, [135] = {
              key = "$DAILY_COND_AL_01_08"
          ,   en  = "Acquire Natural Water"
          ,   de  = "Beschafft natürliches Wasser"
          ,   fr  = "Acquérez de l'eau naturelle"
          ,   es  = "Adquiere agua natural"
          ,   ru  = "Добыть природную воду"
          ,   ja  = "自然水を手に入れる"
          }
, [136] = {
              key = "$DAILY_COND_AL_02_01"
          ,   en  = "Craft Dram of Stamina"
...
, [137] = {
              key = "$DAILY_COND_AL_02_02"
          ,   en  = "Acquire Bugloss"
          ,   de  = "Besorgt etwas Wolfsauge"
          ,   fr  = "Acquérez une noctuelle"
          ,   es  = "Adquiere lengua de buey"
          ,   it  = "Acquire bugloss"
          ,   ru  = "Раздобыть — воловик"
          ,   ja  = "ムラサキ草を手に入れる"
          }
, [138] = {
              key = "$DAILY_COND_AL_02_03"
          ,   en  = "Craft Dram of Ravage Magicka"
          ,   de  = "Stellt Schlücke der Magickaverwüstung her"
          ,   fr  = "Préparez une goutte de ravage de Magie"
          ,   es  = "Prepara un trago de reducción de magia"
          ,   ja  = "マジカ減少の飲み薬を生産する"
          }
, [139] = {
              key = "$DAILY_COND_AL_02_04"
          ,   en  = "Acquire Pristine Water"
          ,   de  = "Beschafft unberührtes Wasser"
          ,   fr  = "Acquérez de l'eau limpide"
          ,   es  = "Adquiere agua prístina"
          ,   ru  = "Добыть нетронутую воду"
          ,   ja  = "清浄水を手に入れる"
          }
, [140] = {
              key = "$DAILY_COND_AL_02_05"
          ,   en  = "Craft Dram of Health"
          ,   de  = "Stellt Schlücke des Lebens her"
          ,   fr  = "Préparez une goutte de Santé"
          ,   es  = "Prepara un trago de salud"
          ,   ja  = "体力の飲み薬を生産する"
          }
, [141] = {
              key = "$DAILY_COND_AL_02_06"
          ,   en  = "Acquire Corn Flower"
          ,   de  = "Besorgt eine Kornblume"
          ,   fr  = "Acquérez un bleuet"
          ,   es  = "Adquiere aciano"
...
, [142] = {
              key = "$DAILY_COND_AL_02_07"
          ,   en  = "Craft Dram of Magicka"
          ,   de  = "Stellt Schlücke der Magicka her"
          ,   fr  = "Préparez une goutte de Magie"
          ,   es  = "Prepara un trago de magia"
          ,   ja  = "マジカの飲み薬を生産する"
          }
, [143] = {
              key = "$DAILY_COND_AL_02_08"
          ,   en  = "Acquire Blessed Thistle"
          ,   de  = "Besorgt etwas Benediktenkraut"
          ,   fr  = "Acquérez un chardon béni"
          ,   es  = "Adquiere cardo bendito"
...
, [144] = {
              key = "$DAILY_COND_AL_03_01"
          ,   en  = "Acquire Lady's Smock"
          ,   de  = "Besorgt etwas Wiesenschaumkraut"
          ,   fr  = "Acquérez une cardamine des prés"
          ,   es  = "Adquiere cardamina"
          ,   it  = "Acquire lady's smock"
          ,   ru  = "Раздобыть — луговой сердечник"
          ,   ja  = "タネツケバナを手に入れる"
          }
, [145] = {
              key = "$DAILY_COND_AL_03_02"
          ,   en  = "Craft Potion of Health"
...
, [146] = {
              key = "$DAILY_COND_AL_03_03"
          ,   en  = "Acquire Mountain Flower"
          ,   de  = "Beschafft eine Bergblume"
          ,   fr  = "Acquérez du lys des cimes"
          ,   es  = "Adquiere una flor de montaña"
          ,   ru  = "Добыть горноцвет"
          ,   ja  = "山の花を手に入れる"
          }
, [147] = {
              key = "$DAILY_COND_AL_03_04"
          ,   en  = "Craft Potion of Magicka"
          ,   de  = "Stellt Tränke der Magicka her"
          ,   fr  = "Préparez une potion de Magie"
          ,   es  = "Prepara una poción de magia"
          ,   ja  = "マジカの薬を生産する"
          }
, [148] = {
              key = "$DAILY_COND_AL_03_05"
          ,   en  = "Acquire Wormwood"
          ,   de  = "Beschafft Wermut"
          ,   fr  = "Acquérez de l'absinthe"
          ,   es  = "Adquiere artemisia"
...
, [149] = {
              key = "$DAILY_COND_AL_03_06"
          ,   en  = "Craft Potion of Stamina"
          ,   de  = "Stellt Tränke der Ausdauer her"
          ,   fr  = "Préparez une potion de Vigueur"
          ,   es  = "Prepara una poción de aguante"
          ,   ja  = "スタミナの薬を生産する"
          }
, [150] = {
              key = "$DAILY_COND_AL_03_07"
          ,   en  = "Acquire Cleansed Water"
          ,   de  = "Beschafft gesäubertes Wasser"
          ,   fr  = "Acquérez de l'eau assainie"
          ,   es  = "Adquiere agua depurada"
          ,   ru  = "Добыть очищенную воду"
          ,   ja  = "浄化水を手に入れる"
          }
, [151] = {
              key = "$DAILY_COND_AL_03_08"
          ,   en  = "Craft Potion of Ravage Health"
          ,   de  = "Stellt Tränke der Lebensverwüstung her"
          ,   fr  = "Préparez une potion de ravage de Santé"
          ,   es  = "Prepara una poción reducción de salud"
          ,   ja  = "体力減少の薬を生産する"
          }
, [152] = {
              key = "$DAILY_COND_AL_04_01"
          ,   en  = "Craft Solution of Stamina"
...
, [154] = {
              key = "$DAILY_COND_AL_04_03"
          ,   en  = "Craft Solution of Health"
          ,   de  = "Stellt Lösungen des Lebens her"
          ,   fr  = "Préparez une solution de Santé"
          ,   es  = "Prepara una solución de salud"
          ,   ja  = "体力の液体薬を生産する"
          }
, [155] = {
              key = "$DAILY_COND_AL_04_04"
          ,   en  = "Acquire Dragonthorn"
          ,   de  = "Besorgt etwas Drachendorn"
          ,   fr  = "Acquérez une épine-de-dragon"
          ,   es  = "Adquiere espina de dragón"
          ,   it  = "Acquire dragonthorn"
          ,   ru  = "Раздобыть — драконий шип"
          ,   ja  = "ドラゴンソーンを手に入れる"
          }
, [156] = {
              key = "$DAILY_COND_AL_04_05"
          ,   en  = "Craft Solution of Magicka"
          ,   de  = "Stellt Lösungen der Magicka her"
          ,   fr  = "Préparez une solution de Magie"
          ,   es  = "Prepara una solución de magia"
          ,   ja  = "マジカの液体薬を生産する"
          }
, [157] = {
...
, [161] = {
          ...
          ,   fr  = "Acquérez de l'eau purifiée"
          ,   es  = "Adquiere agua purificada"
...
, [162] = {
          ...
          ,   fr  = "Fabriquez un élixir de ravage de Magie"
          ,   es  = "Crea un elixir de reducción de magia"
...
, [164] = {
          ...
          ,   fr  = "Préparez un élixir de Santé"
...
, [165] = {
          ...
          ,   fr  = "Préparez un élixir de Magie"
...
, [166] = {
          ...
          ,   fr  = "Acquérez une nirnrave"
          ,   es  = "Adquiere raíz de nirn"
          ,   it  = "Acquire Idode Potency Rune"
...
, [168] = {
          ...
          ,   fr  = "Préparez une panacée de Magie"
...
, [170] = {
          ...
          ,   fr  = "Préparez une panacée de Vigueur"
...
, [172] = {
          ...
          ,   fr  = "Préparez une panacée de ravage de Santé"
...
, [181] = {
          ...
          ,   fr  = "Acquérez un coprin violet"
          ,   es  = "Adquiere coprinus violeta"
...
, [184] = {
          ...
          ,   fr  = "Acquérez une alcaleste"
          ,   es  = "Adquiere alkahest"
          ,   it  = "TRACKER GOAL TEXT"
...
, [187] = {
          ...
          ,   fr  = "Acquérez les larmes de Lorkhan"
          ,   es  = "Adquiere lágrimas de Lorkhan"
          ,   it  = "TRACKER GOAL TEXT"
...
, [190] = {
          ...
          ,   fr  = "Livrez les marchandises au quartier-maître le plus proche"
...
, [191] = {
          ...
          ,   fr  = "Acquérez un œuf d'araignée"
          ,   es  = "Adquiere huevo de araña"
...
, [192] = {
          ...
          ,   fr  = "Fabriquer un poison de Dégâts de Vigueur IX"
...
, [193] = {
          ...
          ,   fr  = "Acquérez une chitine de vasard"
          ,   es  = "Adquiere quitina de cangrejo del barro"
          ,   it  = "TRACKER GOAL TEXT"
...
, [194] = {
          ...
          ,   fr  = "Fabriquez une essence de Vigueur"
          ,   es  = "Prepara una esencia de aguante"
          ,   it  = "TRACKER GOAL TEXT"
          ,   ja  = "スタミナのエキスを生産する"
          }
, [195] = {
          ...
          ,   fr  = "Acquérir le pied-de-lutin"
          ,   es  = "Adquiere seta de diablillo"
...
, [196] = {
          ...
          ,   fr  = "Fabriquez une essence de Magie"
...
, [197] = {
          ...
          ,   fr  = "Acquérez une Belladone"
          ,   es  = "Adquiere belladona"
          ,   ru  = "Раздобыть — Паслен"
          ,   ja  = "ベラドンナを手に入れる"
          }
, [198] = {
          ...
          ,   fr  = "Fabriquer un poison de Dégâts de Santé IX"
...
, [200] = {
          ...
          ,   fr  = "Fabriquez une essence de Santé"
...
, [206] = {
          ...
          ,   fr  = "Fabriquez des gantelets en fer normaux"
          ,   es  = "Fabrica unos guanteletes de hierro normales"
...
, [207] = {
          ...
          ,   fr  = "Fabriquez des solerets en fer normaux"
          ,   es  = "Fabrica unos escarpes de hierro normales"
...
, [208] = {
          ...
          ,   fr  = "Fabriquez une épée longue en fer normale"
          ,   es  = "Fabrica un mandoble de hierro normal"
...
, [209] = {
          ...
          ,   fr  = "Fabriquez des grèves en fer normales"
          ,   es  = "Fabrica unas grebas de hierro normales"
...
, [210] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en fer normale"
          ,   es  = "Fabrica una coraza de hierro normal"
...
, [211] = {
          ...
          ,   fr  = "Fabriquez une épée en fer normale"
          ,   es  = "Fabrica una espada de hierro normal"
          ,   it  = "Craft Iron Sword"
          ,   ja  = "鉄の剣(ノーマル)を生産する"
          }
, [212] = {
...
, [215] = {
          ...
          ,   fr  = "Fabriquez des gantelets en acier normaux"
          ,   es  = "Fabrica unos guanteletes de acero normales"
...
, [216] = {
          ...
          ,   fr  = "Fabriquez des solerets en acier normaux"
          ,   es  = "Fabrica unos escarpes de acero normales"
...
, [217] = {
          ...
          ,   fr  = "Fabriquez une épée longue en acier normale"
          ,   es  = "Fabrica un mandoble de acero normal"
...
, [218] = {
          ...
          ,   fr  = "Fabriquez des grèves en acier normales"
          ,   es  = "Fabrica unas grebas de acero normales"
...
, [219] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en acier normale"
          ,   es  = "Fabrica una coraza de acero normal"
...
, [220] = {
          ...
          ,   fr  = "Fabriquez une épée en acier normale"
          ,   es  = "Fabrica una espada de acero normal"
...
, [224] = {
          ...
          ,   fr  = "Fabriquez des solerets en orichalque normaux"
          ,   es  = "Fabrica unos escarpes de oricalco normales"
...
, [225] = {
          ...
          ,   fr  = "Fabriquez une épée longue en orichalque normale"
          ,   es  = "Fabrica un mandoble de oricalco normal"
...
, [226] = {
          ...
          ,   fr  = "Fabriquez des gantelets en orichalque normaux"
          ,   es  = "Fabrica unos guanteletes de oricalco normales"
...
, [227] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en orichalque normale"
          ,   es  = "Fabrica una coraza de oricalco normal"
...
, [228] = {
          ...
          ,   fr  = "Fabriquez une épée en orichalque normale"
          ,   es  = "Fabrica una espada de oricalco normal"
...
, [229] = {
          ...
          ,   fr  = "Fabriquez des grèves en orichalque normales"
          ,   es  = "Fabrica unas grebas de oricalco normales"
...
, [233] = {
          ...
          ,   fr  = "Fabriquez des gantelets dwemers normaux"
          ,   es  = "Fabrica unos guanteletes de acero enano normales"
...
, [234] = {
          ...
          ,   fr  = "Fabriquez des solerets dwemer normale"
          ,   es  = "Fabrica unos escarpes de acero enano normales"
...
, [235] = {
          ...
          ,   fr  = "Fabriquez une épée longue dwemer normale"
          ,   es  = "Fabrica un mandoble de acero enano normal"
...
, [242] = {
          ...
          ,   fr  = "Fabriquez une dague en ébonite normale"
          ,   es  = "Fabrica una daga de ébano normal"
...
, [243] = {
          ...
          ,   fr  = "Fabriquez un heaume en ébonite normal"
          ,   es  = "Fabrica un yelmo de ébano normal"
          ,   it  = "Craft Ebony Helm"
          ,   ja  = "黒檀の兜(ノーマル)を生産する"
          }
, [244] = {
          ...
          ,   fr  = "Fabriquez des spallières en ébonite normales"
          ,   es  = "Fabrica unos espaldarones de ébano normales"
...
, [245] = {
          ...
          ,   fr  = "Fabriquez des solerets en ébonite normaux"
          ,   es  = "Fabrica unos escarpes de ébano normales"
...
, [246] = {
          ...
          ,   fr  = "Fabriquez une épée longue en ébonite normale"
          ,   es  = "Fabrica un mandoble de ébano normal"
...
, [247] = {
          ...
          ,   fr  = "Fabriquez des gantelets en ébonite normaux"
          ,   es  = "Fabrica unos guanteletes de ébano normales"
...
, [251] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en calcinium normale"
...
, [252] = {
          ...
          ,   fr  = "Fabriquez une épée en calcinium normale"
...
, [253] = {
          ...
          ,   fr  = "Fabriquez des grèves en calcinium normales"
...
, [254] = {
          ...
          ,   fr  = "Fabriquez une dague en calcinium normale"
          ,   es  = "Fabrica una daga de calcinio normal"
...
, [255] = {
          ...
          ,   fr  = "Fabriquez un heaume en calcinium normal"
          ,   es  = "Fabrica un yelmo de calcinio normal"
...
, [256] = {
          ...
          ,   fr  = "Fabriquez des spallières calcinium normales"
          ,   es  = "Fabrica unos espaldarones de calcinio normales"
...
, [260] = {
          ...
          ,   fr  = "Fabriquez une dague en galatite normale"
          ,   es  = "Fabrica una daga de galatita normal"
...
, [261] = {
          ...
          ,   fr  = "Fabriquez un heaume en galatite normal"
          ,   es  = "Fabrica un yelmo de galatita normal"
...
, [262] = {
          ...
          ,   fr  = "Fabriquez des spallières en galatite normales"
          ,   es  = "Fabrica unos espaldarones de galatita normales"
...
, [263] = {
          ...
          ,   fr  = "Fabriquez des solerets en galatite normaux"
          ,   es  = "Fabrica unos escarpes de galatita normales"
...
, [264] = {
          ...
          ,   fr  = "Fabriquez une épée longue en galatite normale"
          ,   es  = "Fabrica un mandoble de galatita normal"
...
, [265] = {
          ...
          ,   fr  = "Fabriquez des gantelets en galatite normaux"
          ,   es  = "Fabrica unos guanteletes de galatita normales"
...
, [270] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en mercure normale"
          ,   es  = "Fabrica una coraza de azogue normal"
...
, [271] = {
          ...
          ,   fr  = "Fabriquez une épée en mercure normale"
          ,   es  = "Fabrica una espada de azogue normal"
...
, [272] = {
          ...
          ,   fr  = "Fabriquez des grèves en mercure normales"
          ,   es  = "Fabrica unas grebas de azogue normales"
...
, [273] = {
          ...
          ,   fr  = "Fabriquez une dague en mercure normale"
          ,   es  = "Fabrica una daga de azogue normal"
...
, [274] = {
          ...
          ,   fr  = "Fabriquez un heaume en mercure normal"
          ,   es  = "Fabrica un yelmo de azogue normal"
...
, [275] = {
          ...
          ,   fr  = "Fabriquez des spallières en mercure normales"
          ,   es  = "Fabrica unos espaldarones de azogue normales"
...
, [279] = {
          ...
          ,   fr  = "Fabriquez des solerets en acier du néant normaux"
          ,   es  = "Fabrica unos escarpes de acero del vacío normales"
...
, [280] = {
          ...
          ,   fr  = "Fabriquez une épée longue en acier du néant normale"
          ,   es  = "Fabrica un mandoble de acero del vacío normal"
...
, [281] = {
          ...
          ,   fr  = "Fabriquez des gantelets en acier du néant normaux"
          ,   es  = "Fabrica unos guanteletes de acero del vacío normales"
...
, [282] = {
          ...
          ,   fr  = "Fabriquez une cuirasse en acier du néant normale"
          ,   es  = "Fabrica unos escarpes de acero del vacío normales"
          ,   it  = "Craft Voidsteel Sabatons"
...
, [283] = {
          ...
          ,   fr  = "Fabriquez une épée en acier du néant normale"
          ,   es  = "Fabrica un mandoble de acero del vacío normal"
          ,   it  = "Craft Voidsteel Greatsword"
...
, [284] = {
          ...
          ,   fr  = "Fabriquez des grèves en acier du néant normales"
          ,   es  = "Fabrica unos guanteletes de acero del vacío normales"
          ,   it  = "Craft Voidsteel Gauntlets"
...
, [285] = {
          ...
          ,   de  = "Stellt normale Leerenstahlkürasse her"
          ,   fr  = "Fabriquez une cuirasse en acier du néant normale"
          ,   es  = "Fabrica una coraza de acero del vacío normal"
...
, [286] = {
          ...
          ,   de  = "Stellt normale Leerenstahlschwerter her"
          ,   fr  = "Fabriquez une épée en acier du néant normale"
          ,   es  = "Fabrica una espada de acero del vacío normal"
...
, [287] = {
          ...
          ,   de  = "Stellt normale Leerenstahlbeinschienen her"
          ,   fr  = "Fabriquez des grèves en acier du néant normales"
          ,   es  = "Fabrica unas grebas de acero del vacío normales"
...
, [292] = {
          ...
          ,   fr  = "Fabriquez une dague en cuprite normale"
          ,   es  = "Fabrica una daga de rubedita normal"
...
, [293] = {
          ...
          ,   fr  = "Fabriquez un heaume en cuprite normal"
          ,   es  = "Fabrica un yelmo de rubedita normal"
...
, [294] = {
          ...
          ,   fr  = "Fabriquez des spallières en cuprite normales"
          ,   es  = "Fabrica unos espaldarones de rubedita normales"
...
, [295] = {
          ...
          ,   fr  = "Fabriquez des gantelets en cuprite normaux"
          ,   es  = "Fabrica unos guanteletes de rubedita normales"
...
, [296] = {
          ...
          ,   fr  = "Fabriquez des solerets en cuprite normaux"
          ,   es  = "Fabrica unos escarpes de rubedita normales"
...
, [297] = {
          ...
          ,   fr  = "Fabriquez une épée longue en cuprite normale"
          ,   es  = "Fabrica un mandoble de rubedita normal"
...
, [304] = {
          ...
          ,   fr  = "Fabriquez un baudrier artisanal normal"
          ,   es  = "Fabrica una banda de tejido artesanal normal"
...
, [305] = {
          ...
          ,   fr  = "Fabriquez un chapeau artisanal normal"
          ,   es  = "Fabrica una capucha de tejido artesanal normal"
...
, [306] = {
          ...
          ,   fr  = "Fabriquez des chaussures artisanales normales"
          ,   es  = "Fabrica unos zapatos de tejido artesanal normales"
...
, [307] = {
          ...
          ,   fr  = "Fabriquez des épaulettes artisanales normales"
          ,   es  = "Fabrica unos cubrehombros de tejido artesanal normal"
...
, [308] = {
          ...
          ,   fr  = "Fabriquez des braies artisanales normales"
          ,   es  = "Fabrica unos calzones de tejido artesanal normales"
...
, [309] = {
          ...
          ,   fr  = "Fabriquez une robe artisanale normale"
          ,   es  = "Fabrica una túnica de tejido artesanal normal"
...
, [313] = {
          ...
          ,   fr  = "Fabriquez un baudrier en lin normal"
          ,   es  = "Fabrica una banda de lino normal"
          ,   it  = "Craft Linen Sash"
...
, [314] = {
          ...
          ,   fr  = "Fabriquez un chapeau en lin normal"
          ,   es  = "Fabrica una capucha de lino normal"
          ,   it  = "Craft Linen Hat"
...
, [315] = {
          ...
          ,   fr  = "Fabriquez des chaussures en lin normales"
          ,   es  = "Fabrica unos zapatos de lino normales"
...
, [316] = {
          ...
          ,   fr  = "Fabriquez des épaulettes en lin normales"
          ,   es  = "Fabrica unos cubrehombros de lino normales"
...
, [317] = {
          ...
          ,   fr  = "Fabriquez des braies en lin normales"
          ,   es  = "Fabrica unos calzones de lino normales"
...
, [318] = {
          ...
          ,   fr  = "Fabriquez une robe en lin normale"
          ,   es  = "Fabrica una túnica de lino normal"
          ,   it  = "Craft Linen Robe"
...
, [322] = {
          ...
          ,   fr  = "Fabriquez un chapeau en coton normal"
          ,   es  = "Fabrica una capucha de algodón normal"
          ,   it  = "Craft Cotton Hat"
...
, [323] = {
          ...
          ,   fr  = "Fabriquez des chaussures en coton normales"
          ,   es  = "Fabrica unos zapatos de algodón normales"
...
, [324] = {
          ...
          ,   es  = "Fabrica una banda de algodón normal"
...
, [325] = {
          ...
          ,   fr  = "Fabriquez des braies en coton normales"
          ,   es  = "Fabrica unos calzones de algodón normales"
...
, [326] = {
          ...
          ,   fr  = "Fabriquez une robe en coton normale"
          ,   es  = "Fabrica una túnica de algodón normal"
...
, [327] = {
          ...
          ,   fr  = "Fabriquez des épaulettes en coton normales"
          ,   es  = "Fabrica un cubrehombros de algodón normales"
...
, [333] = {
          ...
          ,   fr  = "Fabriquez un chapeau en soie d'araignée normal"
          ,   es  = "Fabrica una capucha de seda de araña normal"
...
, [341] = {
          ...
          ,   fr  = "Fabriquez des coques d'épaules déchues normales"
          ,   es  = "Fabrica unas hombreras de piel impía normales"
...
, [342] = {
          ...
          ,   fr  = "Fabriquez un casque déchu normal"
          ,   es  = "Fabrica un casco de piel impía normal"
...
, [343] = {
          ...
          ,   fr  = "Fabriquez des brassards déchus normaux"
          ,   es  = "Fabrica unos brazales de piel impía normales"
...
, [344] = {
          ...
          ,   fr  = "Fabriquez un chapeau en fil d'ébonite normal"
          ,   es  = "Fabrica una capucha de hilo de ébano normal"
...
, [345] = {
          ...
          ,   fr  = "Fabriquez des chaussures en fil d'ébonite normales"
          ,   es  = "Fabrica unos zapatos de hilo de ébano normales"
...
, [346] = {
          ...
          ,   fr  = "Fabriquez un baudrier en fil d'ébonite normal"
          ,   es  = "Fabrica una banda de hilo de ébano normal"
...
, [347] = {
          ...
          ,   fr  = "Fabriquez des coques d'épaules en brigandine normales"
          ,   es  = "Fabrica unas hombreras de brigantina normales"
...
, [348] = {
          ...
          ,   fr  = "Fabriquez un casque en brigandine normal"
          ,   es  = "Fabrica un casco de brigantina normal"
...
, [349] = {
          ...
          ,   fr  = "Fabriquez des brassards en brigandine normaux"
          ,   es  = "Fabrica unos brazales de brigantina normales"
...
, [350] = {
          ...
          ,   fr  = "Fabriquez des braies en kresh normales"
...
, [351] = {
          ...
          ,   fr  = "Fabriquez une robe en kresh normale"
...
, [352] = {
          ...
          ,   fr  = "Fabriquez des épaulettes en kresh normales"
...
, [359] = {
          ...
          ,   fr  = "Fabriquez des coques d'épaules en peau de fer normales"
          ,   es  = "Fabrica unas hombreras de piel férrea normales"
...
, [360] = {
          ...
          ,   fr  = "Fabriquez un casque en peau de fer normal"
          ,   es  = "Fabrica un casco de piel férrea normal"
...
, [361] = {
          ...
          ,   fr  = "Fabriquez des brassards en peau de fer normaux"
          ,   es  = "Fabrica unos brazales de piel férrea normales"
...
, [362] = {
          ...
          ,   fr  = "Fabriquez un chapeau en fil de fer normal"
          ,   es  = "Fabrica una capucha de hilo férreo normal"
...
, [363] = {
          ...
          ,   fr  = "Fabriquez des chaussures en fil de fer normales"
          ,   es  = "Fabrica unos zapatos de hilo férreo normales"
...
, [364] = {
          ...
          ,   fr  = "Fabriquez un baudrier en fil de fer normal"
          ,   es  = "Fabrica una banda de hilo férreo normal"
...
, [368] = {
          ...
          ,   fr  = "Fabriquez des braies en fil d'argent normales"
          ,   es  = "Fabrica unos calzones de hilo de plata normales"
...
, [369] = {
          ...
          ,   fr  = "Fabriquez une robe en fil d'argent normale"
          ,   es  = "Fabrica una túnica de hilo de plata normal"
...
, [370] = {
          ...
          ,   fr  = "Fabriquez des épaulettes en fil d'argent normales"
          ,   es  = "Fabrica unos cubrehombros de hilo de plata normales"
...
, [371] = {
          ...
          ,   fr  = "Fabriquez des coques d'épaules superbes normales"
          ,   es  = "Fabrica unas hombreras de piel soberbia normales"
...
, [372] = {
          ...
          ,   fr  = "Fabriquez un casque superbe normal"
          ,   es  = "Fabrica un casco de piel soberbia normal"
...
, [373] = {
          ...
          ,   fr  = "Fabriquez des brassards superbes normaux"
          ,   es  = "Fabrica unos brazales de piel soberbia normales"
...
, [377] = {
          ...
          ,   fr  = "Fabriquez un chapeau en tissombre normal"
...
, [378] = {
          ...
          ,   fr  = "Fabriquez des chaussures en tissombre normales"
...
, [379] = {
          ...
          ,   fr  = "Fabriquez un baudrier en tissombre normal"
...
, [380] = {
          ...
          ,   es  = "Fabrica unos calzones de tejido sombrío normales"
...
, [381] = {
          ...
          ,   es  = "Fabrica una túnica de tejido sombrío normal"
...
, [382] = {
          ...
          ,   es  = "Fabrica unos cubrehombros de tejido sombrío normales"
...
, [387] = {
          ...
          ,   fr  = "Fabriquez des coques d'épaules en cuir pourpre normales"
          ,   es  = "Fabrica unas hombreras de cuero rubedo normales"
...
, [388] = {
          ...
          ,   fr  = "Fabriquez un casque en cuir pourpre normal"
          ,   es  = "Fabrica un casco de cuero rubedo normal"
...
, [389] = {
          ...
          ,   fr  = "Fabriquez des brassards en cuir pourpre normaux"
          ,   es  = "Fabrica unos brazales de cuero rubedo normales"
...
, [390] = {
          ...
          ,   fr  = "Fabriquez un chapeau en soie ancestrale normal"
          ,   es  = "Fabrica una capucha de seda ancestral normal"
...
, [391] = {
          ...
          ,   fr  = "Fabriquez un baudrier en soie ancestrale normal"
          ,   es  = "Fabrica una banda de seda ancestral normal"
...
, [392] = {
          ...
          ,   fr  = "Fabriquez des chaussures en soie ancestrale normales"
          ,   es  = "Fabrica unos zapatos de seda ancestral normales"
...
, [398] = {
          ...
          ,   fr  = "Fabriquez un glyphe insignifiant vital avec Ta"
          ,   es  = "Fabrica un glifo mediocre de vida con Ta"
...
, [399] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Jode"
          ,   es  = "Adquiere una runa de potencia Jode"
...
, [400] = {
          ...
          ,   fr  = "Fabriquez un glyphe insignifiant magique avec Ta"
          ,   es  = "Fabrica un glifo mediocre de magia con Ta"
...
, [405] = {
          ...
          ,   fr  = "Fabriquez un petit glyphe vital avec Ta"
          ,   es  = "Fabrica un glifo insignificante de vida con Ta"
...
, [406] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Ode"
          ,   es  = "Adquiere una runa de potencia Ode"
...
, [407] = {
          ...
          ,   fr  = "Fabriquez un petit glyphe magique avec Ta"
          ,   es  = "Fabrica un glifo insignificante de magia con Ta"
...
, [411] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Jayde"
          ,   es  = "Adquiere una runa de potencia Jayde"
...
, [412] = {
          ...
          ,   fr  = "Fabriquez un glyphe mineur vital avec Ta"
          ,   es  = "Fabrica un glifo menor de vida con Ta"
...
, [413] = {
          ...
          ,   fr  = "Acquérez une rune d'essence Deni"
          ,   es  = "Adquiere una runa de esencia Deni"
...
, [414] = {
          ...
          ,   fr  = "Fabriquez un glyphe mineur magique avec Ta"
          ,   es  = "Fabrica un glifo menor de magia con Ta"
...
, [419] = {
          ...
          ,   fr  = "Fabriquez un glyphe modéré vital avec Ta"
          ,   es  = "Fabrica un glifo moderado de vida con Ta"
...
, [420] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Pojode"
          ,   es  = "Adquiere una runa de potencia Pojode"
...
, [426] = {
          ...
          ,   fr  = "Fabriquez un glyphe fort vigoureux avec Ta"
          ,   es  = "Fabrica un glifo fuerte de aguante con Ta"
...
, [427] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Hade"
          ,   es  = "Adquiere una runa de potencia Hade"
...
, [428] = {
          ...
          ,   fr  = "Fabriquez un glyphe fort vital avec Ta"
          ,   es  = "Fabrica un glifo fuerte de vida con Ta"
...
, [429] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Idode"
          ,   es  = "Adquiere una runa de potencia Idode"
...
, [434] = {
          ...
          ,   fr  = "Fabriquez un glyphe majeur vigoureux avec Ta"
          ,   es  = "Fabrica un glifo superior de aguante con Ta"
...
, [437] = {
          ...
          ,   fr  = "Fabriquez un glyphe grandiose vigoureux avec Ta"
          ,   es  = "Fabrica un glifo grande de aguante con Ta"
...
, [439] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Pode"
          ,   es  = "Adquiere una runa de potencia Pode"
...
, [440] = {
          ...
          ,   fr  = "Fabriquez un glyphe grandiose vital avec Ta"
          ,   es  = "Fabrica un glifo grande de vida con Ta"
...
, [444] = {
          ...
          ,   fr  = "Fabriquez un glyphe splendide magique avec Ta"
          ,   es  = "Fabrica un glifo espléndido de magia con Ta"
...
, [445] = {
          ...
          ,   fr  = "Acquérez une rune d'essence Makkoma"
          ,   es  = "Adquiere una runa de esencia Makkoma"
...
, [446] = {
          ...
          ,   fr  = "Fabriquez un glyphe splendide vigoureux avec Ta"
          ,   es  = "Fabrica un glifo espléndido de aguante con Ta"
...
, [451] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Rede"
          ,   es  = "Adquiere una runa de potencia Rede"
...
, [452] = {
          ...
          ,   fr  = "Fabriquez un glyphe monumental vital avec Ta"
          ,   es  = "Fabrica un glifo monumental de vida con Ta"
...
, [453] = {
          ...
          ,   fr  = "Fabriquez un glyphe monumental magique avec Ta"
          ,   es  = "Fabrica un glifo monumental de vida con Ta"
          ,   it  = "Craft Monumental Glyph of Health"
...
, [455] = {
          ...
          ,   de  = "Stellt mit einer Ta-Rune eine monumentale Glyphe der Magicka her"
          ,   fr  = "Fabriquez un glyphe monumental magique avec Ta"
          ,   es  = "Fabrica un glifo monumental de magia con Ta"
...
, [456] = {
          ...
          ,   de  = "Beschafft eine Denima-Essenzrune"
          ,   fr  = "Acquérez une rune d'essence Denima"
          ,   es  = "Adquiere una runa de esencia Denima"
...
, [459] = {
          ...
          ,   fr  = "Fabriquez un glyphe de Vigueur superbe avec Ta"
          ,   es  = "Fabrica un glifo soberbio de aguante con Ta"
...
, [461] = {
          ...
          ,   fr  = "Fabriquez un glyphe de Santé superbe avec Ta"
          ,   es  = "Fabrica un glifo soberbio de vida con Ta"
...
, [462] = {
          ...
          ,   fr  = "Acquérez une rune de puissance Jehade"
          ,   es  = "Adquiere una runa de potencia Jehade"
...
, [467] = {
          ...
          ,   fr  = "Fabriquez deux colliers en étain"
          ,   es  = "Fabrica dos collares de peltre"
          ,   it  = "TRACKER GOAL TEXT"
...
, [469] = {
          ...
          ,   fr  = "Fabriquez trois anneaux en étain"
          ,   es  = "Fabrica tres anillos de peltre"
          ,   it  = "TRACKER GOAL TEXT"
...
, [472] = {
          ...
          ,   fr  = "Fabriquez deux colliers en cuivre"
          ,   es  = "Fabrica dos collares de cobre"
          ,   it  = "TRACKER GOAL TEXT"
...
, [473] = {
          ...
          ,   fr  = "Fabriquez trois anneaux en cuivre"
          ,   es  = "Fabrica tres anillos de cobre"
          ,   it  = "TRACKER GOAL TEXT"
...
, [476] = {
          ...
          ,   fr  = "Fabriquez deux colliers en argent"
          ,   es  = "Fabrica dos colgantes de plata"
          ,   it  = "TRACKER GOAL TEXT"
...
, [477] = {
          ...
          ,   fr  = "Fabriquez trois anneaux en argent"
          ,   es  = "Fabrica tres anillos de plata"
          ,   it  = "TRACKER GOAL TEXT"
...
, [478] = {
          ...
          ,   fr  = "Fabriquez trois anneaux en électrum"
          ,   es  = "Fabrica tres anillos de electro"
          ,   it  = "TRACKER GOAL TEXT"
...
, [479] = {
          ...
          ,   fr  = "Fabriquez deux colliers en électrum"
          ,   es  = "Fabrica dos colgantes de electrum"
          ,   it  = "TRACKER GOAL TEXT"
...
, [485] = {
          ...
          ,   fr  = "Fabriquez deux colliers en platine"
...
, [495] = {
          ...
          ,   fr  = "Préparez un blanc de poulet"
          ,   es  = "Preparæ pechuga de pollo"
...
, [497] = {
          ...
          ,   fr  = "Préparez une banane surprise"
          ,   es  = "Preparæ plátano sorpresa"
...
, [498] = {
          ...
          ,   fr  = "Préparez un grog quilouche"
          ,   es  = "Preparæ grog cuatro-ojos"
...
, [502] = {
          ...
          ,   fr  = "Préparez une soupe de carottes"
          ,   es  = "Preparæ Sopa de zanahoria"
...
, [503] = {
          ...
          ,   fr  = "Préparez une cervoise dorée"
          ,   es  = "Preparæ Cerveza rubia dorada"
...
, [504] = {
          ...
          ,   fr  = "Préparez un bâtonnet de poisson"
          ,   es  = "Preparæ Palitos de pescado"
...
, [505] = {
          ...
          ,   fr  = "Préparez un vin de syrah de Surilie"
          ,   es  = "Preparæ vino de syrah de los Surilie"
...
, [510] = {
          ...
          ,   fr  = "Préparez une bière de Tourbefer"
          ,   es  = "Preparæ cerveza del Pantano de Hierro"
...
, [511] = {
          ...
          ,   fr  = "Préparez un clairet de Syrah"
          ,   es  = "Preparæ vino aclarado de syrah"
...
, [512] = {
          ...
          ,   fr  = "Préparez une confiture de raisin"
          ,   es  = "Preparæ conserva de uvas"
...
, [517] = {
          ...
          ,   fr  = "Préparez des carottes à l'ail nibenaises"
          ,   es  = "Preparæ zanahorias al ajo a la nibenesa"
...
, [518] = {
          ...
          ,   fr  = "Préparez un nectar d'orge"
          ,   es  = "Preparæ néctar de cebada"
...
, [519] = {
          ...
          ,   fr  = "Préparez une truite gratinée de Blancherive"
          ,   es  = "Preparæ trucha gratinada de Carrera Blanca"
...
, [520] = {
          ...
          ,   fr  = "Préparez un whisky des sirènes"
          ,   es  = "Preparæ whisky de sirena"
...
, [523] = {
          ...
          ,   fr  = "Préparez un riz à la tomate de Pellitine"
          ,   es  = "Preparæ Arroz con tomate Pellitine"
...
, [524] = {
          ...
          ,   fr  = "Préparez un thé à l'anémone"
          ,   es  = "Preparæ Té de flor marina"
...
, [526] = {
          ...
          ,   fr  = "Préparez des betteraves d'Alik'r au chèvre"
          ,   es  = "Preparæ remolachas de Alik'r con queso de cabra"
...
, [527] = {
          ...
          ,   fr  = "Préparez un mazté soyeux"
          ,   es  = "Preparæ Mazte sedoso"
...
, [531] = {
          ...
          ,   fr  = "Préparez un tord-boyau Elthérique"
          ,   es  = "Preparæ Licor eltérico"
...
, [532] = {
          ...
          ,   fr  = "Préparez une bisque de battaglir"
          ,   es  = "Preparæ Crema de marisco con battaglir"
...
, [533] = {
          ...
          ,   fr  = "Préparez un friand de gibier"
          ,   es  = "Preparæ Licor eltérico"
          ,   it  = "Craft Eltheric Hooch"
          ,   ru  = "Создать — самогон «Элтерический»"
          ,   ja  = "エルセリックの安酒を生産する"
          }
, [534] = {
...
, [536] = {
          ...
          ,   de  = "Stellt etwas Honigwhiskey her"
          ,   fr  = "Préparez un scotch au miel"
          ,   es  = "Preparæ centeno meloso"
          ,   ru  = "Создать — медово-ржаной виски"
          ,   ja  = "ハニーライ・ウイスキーを生産する"
          }
, [537] = {
              key = "$DAILY_COND_PR_03_AD_01"
          ,   en  = "Craft Spiceberry Chai"
          ,   de  = "Stellt etwas Würzbeerenchai her"
          ,   fr  = "Préparez un thé d'épiceline"
          ,   es  = "Preparæ té chai de bayacida"
          ,   ru  = "Создать — пряный ягодный чай"
          ,   ja  = "スパイスベリーのチャイを生産する"
          }
, [538] = {
              key = "$DAILY_COND_PR_03_AD_02"
          ,   en  = "Craft Cyrodilic Pumpkin Fritters"
          ,   de  = "Stellt etwas cyrodiilisches Kürbisfrittiertes her"
          ,   fr  = "Préparez des beignets de citrouille cyrodiiléens"
          ,   es  = "Preparæ buñuelos de calabaza de Cyrodill"
          ,   ru  = "Создать — тыква во фритюре по-сиродильски"
          ,   ja  = "シロディールのカボチャのフリッターを生産する"
          }
, [539] = {
              key = "$DAILY_COND_PR_03_AD_03"
          ,   en  = "Brewers and Cooks Can Provide Recipes"
          ,   de  = "Brauer und Köche verkaufen Rezepte"
          ,   fr  = "Les brasseurs et cuisiniers peuvent fournir des recettes"
          ,   es  = "Los cerveceros y los cocineros pueden proporcionar recetas"
...
, [540] = {
              key = "$DAILY_COND_PR_03_AD_04"
          ,   en  = "Craft Spiced Mazte"
          ,   de  = "Stellt etwas Würzmazte her"
          ,   fr  = "Préparez un mazté épicé"
          ,   es  = "Preparæ mazte especiado"
          ,   ru  = "Создать — пряный мацт"
          ,   ja  = "香辛料入りマッツェを生産する"
          }
, [541] = {
              key = "$DAILY_COND_PR_03_AD_05"
          ,   en  = "Craft Chorrol Corn on the Cob"
          ,   de  = "Stellt einen Chorrol-Maiskolben am Stück her"
          ,   fr  = "Préparez un maïs grillé de Chorrol"
          ,   es  = "Preparæ mazorca de maíz de Chorrol"
          ,   ru  = "Создать — корролский початок кукурузы"
          ,   ja  = "コロールの軸付きトウモロコシを生産する"
          }
, [542] = {
              key = "$DAILY_COND_PR_03_AD_06"
          ,   en  = "Craft Sorry, Honey Lager"
          ,   de  = "Stellt etwas Tutmirleidlager her"
          ,   fr  = "Préparez une cervoise « Désolé, chérie »"
          ,   es  = "Preparæ cerveza \"Lo siento, cariño\""
          ,   ru  = "Создать — лагер «Извини, дорогая»"
          ,   ja  = "ソーリー、ハニーラガーを生産する"
          }
, [543] = {
              key = "$DAILY_COND_PR_03_AD_07"
          ,   en  = "Craft Elinhir Roast Antelope"
          ,   de  = "Stellt eine Elinhir-Grillantilope her"
          ,   fr  = "Préparez une antilope rôtie d'Élinhir"
          ,   es  = "Preparæ antílope asado de Elinhir"
          ,   ru  = "Создать — жареная оленина по-элинирски"
          ,   ja  = "エリンヒルの羚羊の肉のローストを生産する"
          }
, [544] = {
              key = "$DAILY_COND_PR_03_DC_01"
          ,   en  = "Craft Torval Mint Tea"
          ,   de  = "Stellt etwas Torval-Minztee her"
          ,   fr  = "Préparez un thé à la menthe de Torval"
          ,   es  = "Preparæ Té de menta de Torval"
          ,   ru  = "Создать — торвальский мятный чай"
          ,   ja  = "トルヴァルミントティーを生産する"
          }
, [545] = {
              key = "$DAILY_COND_PR_03_DC_02"
          ,   en  = "Craft Cinnamon Grape Jelly"
          ,   de  = "Stellt etwas Zimttraubengelee her"
          ,   fr  = "Préparez une gelée de raisins à la cannelle"
          ,   es  = "Preparæ Jalea de uva con canela"
          ,   ru  = "Создать — виноградное желе с корицей"
          ,   ja  = "グレープシナモンゼリーを生産する"
          }
, [546] = {
              key = "$DAILY_COND_PR_03_DC_03"
          ,   en  = "Brewers and Cooks Can Provide Recipes"
          ,   de  = "Brauer und Köche verkaufen Rezepte"
          ,   fr  = "Les brasseurs et cuisiniers peuvent fournir des recettes"
          ,   es  = "Los cerveceros y los cocineros pueden proporcionar recetas"
...
, [547] = {
              key = "$DAILY_COND_PR_03_DC_04"
          ,   en  = "Craft Garlic Mashed Potatoes"
          ,   de  = "Stellt etwas Kartoffelpüree mit Knoblauch her"
          ,   fr  = "Préparez une purée à l'ail"
          ,   es  = "Preparæ Puré de patatas con ajo"
          ,   ru  = "Создать — картофельное пюре с чесноком"
          ,   ja  = "ガーリックマッシュポテトを生産する"
          }
, [548] = {
              key = "$DAILY_COND_PR_03_DC_05"
          ,   en  = "Craft Mulled Wine"
          ,   de  = "Stellt etwas Glühwein her"
          ,   fr  = "Préparez un vin chaud"
          ,   es  = "Preparæ Vino caliente"
          ,   ru  = "Создать — пряное вино"
          ,   ja  = "ホットワインを生産する"
          }
, [549] = {
              key = "$DAILY_COND_PR_03_DC_06"
          ,   en  = "Craft Nereid Wine"
          ,   de  = "Stellt etwas Nereïdenwein her"
          ,   fr  = "Préparez un vin de la néréïde"
          ,   es  = "Preparæ Vino de nereida"
          ,   ru  = "Создать — вино нереиды"
          ,   ja  = "ネレイドワインを生産する"
          }
, [550] = {
              key = "$DAILY_COND_PR_03_DC_07"
          ,   en  = "Craft Senchal Curry Fish and Rice"
          ,   de  = "Stellt einen Senchal-Curryfisch mit Reis her"
          ,   fr  = "Préparez un curry de poisson de Senchal"
          ,   es  = "Preparæ Curry de pescado y arroz de Senchal"
          ,   ru  = "Создать — сенчальское рыбное карри с рисом"
          ,   ja  = "センシャルのシーフードカレーを生産する"
          }
, [551] = {
...
, [554] = {
          ...
          ,   fr  = "Préparez un gâteau de carotte de l'auberge de la vue de Jerall"
          ,   es  = "Preparæ Pastel de zanahoria \"El Paisaje de Jerall\""
...
, [555] = {
          ...
          ,   fr  = "Préparez un moût aigre"
          ,   es  = "Preparæ Malta agria"
...
, [556] = {
          ...
          ,   fr  = "Préparez un scotch-dans-ta-face"
          ,   es  = "Preparæ cente-no en la cara"
          ,   it  = "Craft Rye-in-your-Eye"
...
, [557] = {
          ...
          ,   fr  = "Préparez un lièvre à l'ail"
          ,   es  = "Preparæ Liebre en salsa de ajo"
...
, [562] = {
          ...
          ,   fr  = "Préparez un pain de maïs cyrodiiléen"
          ,   es  = "Preparæ pan de maíz cyrodílico"
...
, [563] = {
          ...
          ,   fr  = "Préparez un Les-Dieux-M'aveuglent"
          ,   es  = "Preparæ Vino Cegado-Por-Dioses"
...
, [564] = {
          ...
          ,   fr  = "Préparez un croustillant au jazbay de Bordeciel"
          ,   es  = "Preparæ crostata de jazbay de Skyrim"
...
, [565] = {
          ...
          ,   fr  = "Préparez un marathon de Sente-azur"
          ,   es  = "Preparæ maratón de Blue Road"
...
, [568] = {
          ...
          ,   fr  = "Préparez un tonique du papi au lit"
          ,   es  = "Preparæ tónico de dormir del abuelo"
...
, [569] = {
          ...
          ,   fr  = "Préparez une gelée de pommes à l'ail d'Orcrête"
          ,   es  = "Preparæ jalea de manzana y ajo de Orcelia"
...
, [571] = {
          ...
          ,   fr  = "Préparez un whiskey de l'accorte hôtesse"
          ,   es  = "Preparæ whisky de la doncella encantadora"
...
, [572] = {
          ...
          ,   fr  = "Préparez une bisque au maïs occidental froide"
          ,   es  = "Preparæ caldo de maíz del Bosque Occidental"
...
, [575] = {
          ...
          ,   fr  = "Préparez un plateau de fruits et de fromage de Prime-Tenure"
          ,   es  = "Preparæ plato de frutas y queso de Primada"
...
, [576] = {
          ...
          ,   fr  = "Préparez un remords de Muthséra"
          ,   es  = "Preparæ remordimiento de muthsera"
...
, [577] = {
          ...
          ,   fr  = "Préparez une soupe de maïs épaisse à l'ail"
          ,   es  = "Preparæ caldo espeso de maíz y ajo"
...
, [578] = {
          ...
          ,   fr  = "Préparez un hydromel de Markarth"
          ,   es  = "Preparæ aguamiel de Markarth"
...
, [583] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en érable normal"
          ,   es  = "Fabrica una vara eléctrica de arce normal"
...
, [584] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en érable normal"
          ,   es  = "Fabrica una vara glaciar de arce normal"
...
, [585] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en érable normal"
          ,   es  = "Fabrica una vara infernal de arce normal"
...
, [586] = {
          ...
          ,   fr  = "Fabriquez un bâton de rétablissement en érable normal"
          ,   es  = "Fabrica una vara restauradora de arce normal"
...
, [588] = {
          ...
          ,   fr  = "Fabriquez un bâton de rétablissement normal"
          ,   es  = "Fabrica una vara restauradora de roble normal"
...
, [589] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en chêne normal"
          ,   es  = "Fabrica una vara eléctrica de roble normal"
...
, [590] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en chêne normal"
          ,   es  = "Fabrica una vara glaciar de roble normal"
...
, [591] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en chêne normal"
          ,   es  = "Fabrica una vara infernal de roble normal"
...
, [595] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en hêtre normal"
          ,   es  = "Fabrica una vara glaciar de haya normal"
...
, [596] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en hêtre normal"
          ,   es  = "Fabrica una vara infernal de haya normal"
...
, [597] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en hêtre normal"
          ,   es  = "Fabrica una vara eléctrica de haya normal"
...
, [598] = {
          ...
          ,   fr  = "Fabriquez un bâton de rétablissement en hêtre normal"
          ,   es  = "Fabrica una vara restauradora de haya normal"
...
, [601] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en noyer normal"
          ,   es  = "Fabrica una vara eléctrica de nogal normal"
...
, [602] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en noyer normal"
          ,   es  = "Fabrica una vara glaciar de nogal normal"
...
, [603] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en noyer normal"
          ,   es  = "Fabrica una vara infernal de nogal normal"
...
, [607] = {
          ...
          ,   fr  = "Fabriquez un arc en if normal"
          ,   es  = "Fabrica un arco de tejo normal"
          ,   it  = "Craft Yew Bow"
          ,   ja  = "イチイの弓(ノーマル)を生産する"
          }
, [608] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en if normal"
          ,   es  = "Fabrica una vara glaciar de tejo normal"
...
, [609] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en if normal"
          ,   es  = "Fabrica una vara infernal de tejo normal"
...
, [610] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en if normal"
          ,   es  = "Fabrica una vara eléctrica de tejo normal"
...
, [614] = {
          ...
          ,   fr  = "Fabriquez un bouclier en bouleau normal"
...
, [615] = {
          ...
          ,   fr  = "Fabriquez un bâton de rétablissement en bouleau normal"
...
, [616] = {
          ...
          ,   fr  = "Fabriquez un arc en bouleau normal"
          ,   es  = "Fabrica un arco de abedul normal"
          ,   it  = "Craft Birch Bow"
...
, [619] = {
          ...
          ,   fr  = "Fabriquez un arc en frêne normal"
          ,   es  = "Fabrica un arco de fresno normal"
          ,   it  = "Craft Ash Bow"
...
, [620] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en frêne normal"
          ,   es  = "Fabrica una vara glaciar de fresno normal"
...
, [621] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en frêne normal"
          ,   es  = "Fabrica una vara infernal de fresno normal"
...
, [622] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en frêne normal"
          ,   es  = "Fabrica una vara eléctrica de fresno normal"
...
, [626] = {
          ...
          ,   fr  = "Fabriquez un bouclier en acajou normal"
          ,   es  = "Fabrica un escudo de caoba normal"
...
, [627] = {
          ...
          ,   fr  = "Fabriquez un bâton de rétablissement en acajou normal"
          ,   es  = "Fabrica una vara restauradora de caoba normal"
...
, [628] = {
          ...
          ,   fr  = "Fabriquez un arc en acajou normal"
          ,   es  = "Fabrica un arco de caoba normal"
...
, [631] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en bois de nuit normal"
...
, [632] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en bois de nuit normal"
...
, [633] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en bois de nuit normal"
          ,   es  = "Fabrica una vara eléctrica de nocteca normal"
...
, [634] = {
          ...
          ,   es  = "Fabrica una vara restauradora de nocteca normal"
...
, [637] = {
          ...
          ,   fr  = "Fabriquez un arc en frêne roux normal"
          ,   es  = "Fabrica un arco de fresno rubí normal"
...
, [638] = {
          ...
          ,   fr  = "Fabriquez un bâton de glace en frêne roux normal"
          ,   es  = "Fabrica una vara glaciar de fresno rubí normal"
...
, [639] = {
          ...
          ,   fr  = "Fabriquez un bâton infernal en frêne roux normal"
          ,   es  = "Fabrica una vara infernal de fresno rubí normal"
...
, [640] = {
          ...
          ,   fr  = "Fabriquez un bâton de foudre en frêne roux normal"
          ,   es  = "Fabrica una vara eléctrica de fresno rubí normal"
...
, [649] = {
          ...
          ,   fr  = "Cette commande émane du Comité civique de Vengeance et du Renouveau d'Orsinium, qui a besoin de fournitures mais ne veut pas manquer de respect à ses forgerons. Ils ont besoin de plusieurs casques, dagues et spallières pour équiper leurs guerriers."
...
, [652] = {
          ...
          ,   fr  = "Cette commande émane du Comité civique de Vengeance et du Renouveau d'Orsinium, qui a besoin de fournitures mais ne veut pas manquer de respect à ses travailleurs du cuir. Ils ont besoin de plusieurs casques, coques de bras et brassards pour équiper leurs guerriers."
...
, [655] = {
          ...
          ,   fr  = "Cette commande émane du Comité civique de Vengeance et du Renouveau d'Orsinium, qui a besoin de fournitures mais ne veut pas manquer de respect à ses enchanteurs. Ils ont besoin d'un glyphe de Vigueur superbe et d'une rune d'aspect Ta pour équiper leurs guerriers."
...
, [661] = {
          ...
          ,   fr  = "Cette commande émane du Comité civique de Vengeance et du Renouveau d'Orsinium, qui a besoin de fournitures mais ne veut pas manquer de respect à ses cuisiniers. On m'a demandé de préparer un plateau de fruits et de fromage de Prime-Tenure et un remords de Muthséra pour remplir la commande."
...
, [664] = {
          ...
          ,   fr  = "Cette commande émane du Comité civique de Vengeance et du Renouveau d'Orsinium, qui a besoin de fournitures mais ne veut pas manquer de respect à ses travailleurs du bois. Ils ont besoin de plusieurs arcs et de boucliers pour équiper leurs guerriers."
...
, [668] = {
              key = "$DELIVER_ALLIANCE_DEPOT"
          ,   en  = "Deliver Goods to Alliance Supply Depot"
          }
, [669] = {
              key = "$DELIVER_CONSORTIUM_TRADEPOST"
          ,   en  = "Deliver Goods to Consortium Tradepost"
          }
, [670] = {
              key = "$DELIVER_FIGHTERS_GUILD"
          ,   en  = "Deliver Goods to Fighters Guild Provisioner"
          }
, [671] = {
              key = "$DELIVER_GOODS_SUBSTRING"
          ,   en  = "Deliver Goods to "
          ,   de  = "Beliefert "
          ,   fr  = "Livrez les marchandises"
          ,   es  = "Entrega la mercancía"
          ,   it  = "TRACKER GOAL TEXT"
          ,   ru  = "Доставить товары"
          ,   ja  = "に届ける"
          }
, [672] = {
              key = "$DELIVER_NEAREST_QUARTERMASTER"
          ,   en  = "Deliver Goods to Nearest Writ Quartermaster"
          ,   de  = "Beliefert den nächsten Quartiermeister für Handwerksschriebe"
          ,   fr  = "Livrez les marchandises au quartier-maître le plus proche"
          ,   es  = "Entrega la mercancía al intendente más cercano"
...
, [673] = {
              key = "$DELIVER_REFUGEE_RELIEF"
          ,   en  = "Deliver Goods to Refugee Relief Site"
          }
, [674] = {
              key = "$ESSENCE_045831_ADD"
          ,   en  = "health"
          ,   de  = "lebens"
          ,   fr  = "vital"
          ,   es  = "vida"
...
, [679] = {
              key = "$ESSENCE_045832_SUB"
          ,   en  = "absorb magicka"
          ,   de  = "magickaabsorption"
          ,   fr  = "d'absorption de magie"
          ,   es  = "absorción de magia"
          ,   ja  = "マジカ吸収"
          }
, [680] = {
              key = "$ESSENCE_045833_ADD"
          ,   en  = "stamina"
          ,   de  = "ausdauer"
          ,   fr  = "vigoureux"
          ,   es  = "aguante"
...
, [682] = {
              key = "$ESSENCE_045833_SUB"
          ,   en  = "absorb stamina"
          ,   de  = "ausdauerabsorption"
          ,   fr  = "d'absorption de vigueur"
          ,   es  = "absorción de aguante"
          ,   ja  = "スタミナ吸収"
          }
, [683] = {
...
, [686] = {
              key = "$ESSENCE_045835_SUB"
          ,   en  = "reduce spell cost"
          ,   de  = "zauberkostenminderung"
          ,   fr  = "du mage"
          ,   es  = "brujería"
          ,   ja  = "呪文消費減少"
          }
...
, [688] = {
              key = "$ESSENCE_045836_SUB"
          ,   en  = "reduce feat cost"
          ,   de  = "fähigkeitenkostenminderung"
          ,   fr  = "du virtuose"
          ,   es  = "virtuosidad"
          ,   ja  = "技能消費減少"
          }
...
, [690] = {
              key = "$ESSENCE_045837_SUB"
          ,   en  = "poison resist"
          ,   de  = "giftresistenz"
          ,   fr  = "de résistance au poison"
...
, [694] = {
              key = "$ESSENCE_045839_SUB"
          ,   en  = "frost resist"
          ,   de  = "frostresistenz"
          ,   fr  = "de résistance au givre"
...
, [698] = {
              key = "$ESSENCE_045841_SUB"
          ,   en  = "disease resist"
          ,   de  = "seuchenresistenz"
          ,   fr  = "de résistance à la maladie"
...
, [706] = {
              key = "$ESSENCE_045847_SUB"
          ,   en  = "decrease physical harm"
          ,   de  = "verringerten physischen schadens"
          ,   fr  = "de résistance physique"
...
, [708] = {
              key = "$ESSENCE_045848_SUB"
          ,   en  = "decrease spell harm"
          ,   de  = "verringerten magischen schadens"
          ,   fr  = "de résistance magique"
...
, [712] = {
              key = "$ESSENCE_068342_SUB"
          ,   en  = "prismatic onslaught"
          ,   de  = "prismatischen ansturms"
          ,   fr  = "d'assaut prismatique"
          ,   es  = "asalto prismático"
          ,   ja  = "分光猛襲"
          }
, [713] = {
              key = "$FINISHED_AL"
...
, [724] = {
              key = "$FOOD_028346"
          ,   en  = "Garlic Mashed Potatoes"
          ,   de  = "Kartoffelpüree mit Knoblauch"
          ,   fr  = "purée à l'ail"
          ,   es  = "Puré de patatas con ajo"
          ,   ru  = "картофельное пюре с чесноком"
          ,   ja  = "ガーリックマッシュポテト"
          ,   recipe_list_index = 3
          ,   recipe_index = 19
...
, [725] = {
              key = "$FOOD_028350"
          ,   en  = "Senchal Curry Fish and Rice"
          ,   de  = "Senchal-Curryfisch mit Reis"
          ,   fr  = "curry de poisson de Senchal"
          ,   es  = "Curry de pescado y arroz de Senchal"
          ,   ru  = "сенчальское рыбное карри с рисом"
          ,   ja  = "センシャルのシーフードカレー"
          ,   recipe_list_index = 1
          ,   recipe_index = 19
...
, [745] = {
              key = "$FOOD_028513"
          ,   en  = "Blue Road Marathon"
          ,   de  = "Blauweg-Marathon"
          ,   fr  = "marathon de Sente-azur"
          ,   es  = "maratón de Blue Road"
          ,   ru  = "«Марафон по Синей дороге»"
          ,   ja  = "ブルーロード・マラソン"
          ,   recipe_list_index = 10
          ,   recipe_index = 25
...
, [750] = {
              key = "$FOOD_033514"
          ,   en  = "Chorrol Corn on the Cob"
          ,   de  = "Chorrol-Maiskolben am Stück"
          ,   fr  = "maïs grillé de Chorrol"
          ,   es  = "mazorca de maíz de Chorrol"
          ,   ru  = "корролский початок кукурузы"
          ,   ja  = "コロールの軸付きトウモロコシ"
          ,   recipe_list_index = 3
          ,   recipe_index = 20
...
, [751] = {
              key = "$FOOD_033520"
          ,   en  = "Elinhir Roast Antelope"
          ,   de  = "Elinhir-Grillantilope"
          ,   fr  = "antilope rôtie d'Élinhir"
          ,   es  = "antílope asado de Elinhir"
          ,   ru  = "жареная оленина по-элинирски"
          ,   ja  = "エリンヒルの羚羊の肉のロースト"
          ,   recipe_list_index = 1
          ,   recipe_index = 20
...
, [766] = {
              key = "$FOOD_033642"
          ,   en  = "Sorry, Honey Lager"
          ,   de  = "Tutmirleidlager"
          ,   fr  = "cervoise « Désolé, chérie »"
          ,   es  = "cerveza \"Lo siento, cariño\""
          ,   ru  = "лагер «Извини, дорогая»"
          ,   ja  = "ソーリー、ハニーラガー"
          ,   recipe_list_index = 8
          ,   recipe_index = 23
...
, [768] = {
          ...
          ,   de  = "Würzbeerenchai"
          ,   fr  = "thé d'épiceline"
          ,   es  = "té chai de bayacida"
          ,   ru  = "пряный ягодный чай"
          ,   ja  = "スパイスベリーのチャイ"
          ,   recipe_list_index = 9
          ,   recipe_index = 20
...
, [769] = {
              key = "$FOOD_033789"
          ,   en  = "Cyrodilic Pumpkin Fritters"
          ,   de  = "cyrodiilisches Kürbisfrittiertes"
          ,   fr  = "beignets de citrouille cyrodiiléens"
          ,   es  = "buñuelos de calabaza de Cyrodill"
          ,   ru  = "тыква во фритюре по-сиродильски"
...
, [776] = {
              key = "$FOOD_033909"
          ,   en  = "Skyrim Jazbay Crostata"
          ,   de  = "Himmelsrand-Jazbuchtcrostata"
          ,   fr  = "croustillant au jazbay de Bordeciel"
          ,   es  = "crostata de jazbay de Skyrim"
          ,   ru  = "песочная полоска с желе из винограда джазби"
...
, [785] = {
          ...
          ,   en  = "Torval Mint Tea"
          ,   de  = "Torval-Minztee"
          ,   fr  = "thé à la menthe de Torval"
          ,   es  = "Té de menta de Torval"
          ,   ru  = "торвальский мятный чай"
          ,   ja  = "トルヴァルミントティー"
          ,   recipe_list_index = 9
          ,   recipe_index = 21
...
, [786] = {
              key = "$FOOD_042790"
          ,   en  = "Cinnamon Grape Jelly"
          ,   de  = "Zimttraubengelee"
          ,   fr  = "gelée de raisins à la cannelle"
          ,   es  = "Jalea de uva con canela"
          ,   ru  = "виноградное желе с корицей"
          ,   ja  = "グレープシナモンゼリー"
          ,   recipe_list_index = 2
          ,   recipe_index = 19
...
, [790] = {
          ...
          ,   en  = "Psijic Ambrosia"
          ,   de  = "Psijik-Ambrosia"
          ,   fr  = "ambroisie psijique"
          ,   es  = "ambrosía psijic"
          ,   ru  = "амброзия Псиджиков"
          ,   ja  = "サイジックのアンブロージア"
...
, [795] = {
              key = "$FOOD_068251"
          ,   en  = "Capon Tomato-Beet Casserole"
          ,   de  = "Kapaunauflauf mit Tomaten und Gemüse"
          ,   fr  = "ragoût de capon aux tomates et aux betteraves"
          ,   ru  = "томатно-свекольная запеканка с каплуном"
...
, [796] = {
              key = "$FOOD_068252"
          ,   en  = "Jugged Rabbit in Preserves"
          ,   de  = "Hasenpfeffer mit Eingemachtem"
          ,   fr  = "conserve de lapin confit"
          ,   ru  = "консервированный тушеный кролик"
          ,   ja  = "ジャムで煮込んだ兎肉"
          ,   recipe_list_index = 7
          ,   recipe_index = 29
...
, [797] = {
              key = "$FOOD_068253"
          ,   en  = "Longfin Pasty with Melon Sauce"
          ,   de  = "Langflossenpastete mit Melonensoße"
          ,   fr  = "friand de nagelongue à la sauce au melon"
          ,   ru  = "хлебный конверт с окунем в дынном соусе"
...
, [798] = {
          ...
          ,   de  = "Langflossenpastete mit Melonensoße"
          ,   fr  = "friand de nagelongue à la sauce au melon"
          ,   ru  = "хлебный конверт с окунем в дынном"
          ,   ja  = "ロングフィンのパイのメロンソース添え"
          ,   recipe_list_index = 7
          ,   recipe_index = 30
          }
, [799] = {
              key = "$FOOD_068254"
          ,   en  = "Withered Tree Inn Venison Pot Roast"
          ,   de  = "Wildtopfbraten aus dem Verdorrten Baum"
          ,   fr  = "rôti de gibier de l'auberge de l'Arbre flétri"
          ,   ru  = "тушеная оленина из «Высохшего дерева»"
...
, [803] = {
              key = "$FOOD_068273"
          ,   en  = "Senche-Tiger Single Malt"
          ,   de  = "Senchetiger-Whiskey"
          ,   fr  = "single malt du tigre-senche"
          ,   ru  = "односолодовый виски «Сенч-тигр»"
          ,   ja  = "センチタイガーのシングルモルト"
...
, [805] = {
              key = "$FOOD_068274"
          ,   en  = "Velothi View Vintage Malbec"
          ,   de  = "Velothi-Fernmalbec"
          ,   fr  = "vieux cru vélothi de Malbec"
          ,   ru  = "выдержанный мальбек «Велотийский вид»"
...
, [806] = {
          ...
          ,   de  = "Velothi-Fernmalbec"
          ,   fr  = "vieux cru vélothi de Malbec"
          ,   ru  = "выдержанный мальбек «Велотийский"
          ,   ja  = "ヴェロシビューのビンテージマルベックワイン"
          ,   recipe_list_index = 14
          ,   recipe_index = 29
          }
, [807] = {
              key = "$FOOD_068275"
          ,   en  = "Orcrest Agony Pale Ale"
          ,   de  = "Orkruh-Schmerzbleichale"
          ,   fr  = "bière blonde d'agonie d'Orcrête"
          ,   es  = "cerveza pálida de la agonía de Orcelia"
          ,   ru  = "светлый эль «Агония Оркреста»"
          ,   ja  = "オークレストの苦悶のペールエール"
          ,   recipe_list_index = 14
          ,   recipe_index = 30
...
, [809] = {
              key = "$FOOD_068276"
          ,   en  = "Lusty Argonian Maid Mazte"
          ,   de  = "Mazte der munteren argonischen Maid"
          ,   fr  = "mazté de la femme de chambre argonienne"
          ,   es  = "Mazte de la sensual doncella argoniana"
          ,   ru  = "мацт «Похотливая аргонианская дева»"
...
, [810] = {
          ...
          ,   fr  = "mazté de la femme de chambre argonienne"
          ,   es  = "Mazte de la sensual doncella argoniana"
          ,   ru  = "мацт «Похотливая аргонианская дев"
          ,   ja  = "好色なアルゴニアンの侍女のマッツェ"
          ,   recipe_list_index = 14
          ,   recipe_index = 31
          }
, [811] = {
              key = "$FOOD_071056"
          ,   en  = "Orzorga's Red Frothgar"
          ,   de  = "Orzorgas rotes Frothgar"
          ,   fr  = "bouillon rouge d'Orzorga"
          ,   es  = "Caldo rojo de Orzorga"
          ,   ru  = "красный пенный напиток от Орзорги"
          ,   ja  = "オーゾーガのレッド・フロスガー"
          ,   recipe_list_index = 15
          ,   recipe_index = 14
...
, [812] = {
          ...
          ,   fr  = "bouillon rouge d'Orzorga"
          ,   es  = "Caldo rojo de Orzorga"
          ,   ru  = "красный пенный напиток от Ор"
          ,   ja  = "オーゾーガのレッド・フロスガー"
          ,   recipe_list_index = 15
          ,   recipe_index = 14
          }
, [813] = {
              key = "$FOOD_071057"
          ,   en  = "Orzorga's Tripe Trifle Pocket"
          ,   de  = "Orzorgas kleines Schundtäschchen"
          ,   fr  = "charlotte aux tripes d'Orzorga"
          ,   es  = "callos con todo de Ozorga"
          ,   ru  = "хлебный конверт с требухой от Орзорги"
...
, [814] = {
          ...
          ,   fr  = "charlotte aux tripes d'Orzorga"
          ,   es  = "callos con todo de Ozorga"
          ,   ru  = "хлебный конверт с требухой от Орзо"
          ,   ja  = "オーゾーガの牛の内臓ミンチ入りのパン"
          ,   recipe_list_index = 16
          ,   recipe_index = 2
          }
, [815] = {
              key = "$FOOD_071058"
          ,   en  = "Orzorga's Blood Price Pie"
          ,   de  = "Orzorgas Blutzoll-Pastete"
          ,   fr  = "tarte « Prix du sang » d'Orzorga"
          ,   es  = "Tarta del precio de sangre de Orzorga"
          ,   ru  = "ценная корзиночка с кровью от Орзорги"
...
, [816] = {
          ...
          ,   fr  = "tarte « Prix du sang » d'Orzorga"
          ,   es  = "Tarta del precio de sangre de Orzorga"
          ,   ru  = "ценная корзиночка с кровью от Орзо"
          ,   ja  = "オーゾーガのブラッド・プライス・パイ"
          ,   recipe_list_index = 16
          ,   recipe_index = 3
          }
, [817] = {
              key = "$FOOD_071059"
          ,   en  = "Orzorga's Smoked Bear Haunch"
          ,   de  = "Orzorgas geräucherte Bärenlende"
          ,   fr  = "cuissot d'ours fumé d'Orzorga"
          ,   es  = "Pierna de oso ahumada de Orzorga"
          ,   ru  = "копченый медвежий окорок от Орзорги"
          ,   ja  = "オーゾーガの熊の腰肉の燻製"
          ,   recipe_list_index = 16
          ,   recipe_index = 4
...
, [818] = {
          ...
          ,   fr  = "cuissot d'ours fumé d'Orzorga"
          ,   es  = "Pierna de oso ahumada de Orzorga"
          ,   ru  = "копченый медвежий окорок от Орзо"
          ,   ja  = "オーゾーガの熊の腰肉の燻製"
          ,   recipe_list_index = 16
          ,   recipe_index = 4
          }
, [819] = {
              key = "$HINT_PR_BREWERS_COOKS_RECIPES"
          ,   en  = "Brewers and Cooks Can Provide Recipes"
          ,   de  = "Brauer und Köche verkaufen Rezepte"
          ,   fr  = "Les brasseurs et cuisiniers peuvent fournir des recettes"
          ,   es  = "Los cerveceros y los cocineros pueden proporcionar recetas"
...
, [864] = {
              key = "$MASTER_COND_0002"
          ,   en  = "Craft a Ruby Ash Restoration Staff with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: Oblivion's Foe\n• Style: Bloodforge\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenheilungsstab mit bestimmten Eigenschaften her.\n• Set: Erinnerung\n• Stil: Blutquellschmiede\n• Eigenschaft: Nirngeschliffen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Bâton de rétablissement en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : l’Adversaire d'Oblivion\n• Style : Forgesang\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara restauradora de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Enemigo de Oblivion\n• Estilo: Forja de Sangre\n• Progreso: 0/1"
          ,   it  = "Crea un Healing Staff con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Oblivion's Foe\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Restoration Staff) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Oblivion's Foe\n• Стиль: Кровавая кузница\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの回復の杖 with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: 反オブリビオン\n• Style: ブラッドフォージ\n• Progress: 0 / 1"
          }
, [865] = {
              key = "$MASTER_COND_0003"
          ,   en  = "Travel to Wayrest to Meet Your Contact"
          ,   de  = "Reist nach Wegesruh, um Euren Kontakt zu treffen"
          ,   fr  = "Allez rencontrer votre contact à Haltevoie"
...
, [867] = {
              key = "$MASTER_COND_0005"
          ,   en  = "Craft a Superb Glyph of Stamina Recovery\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe der Ausdauerregeneration her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe revigorant\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de regeneración de aguante• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Stamina Recovery\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Stamina Recovery\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (スタミナ再生)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [868] = {
              key = "$MASTER_COND_0006"
          ,   en  = "Craft a Damage Health Poison IX with the following Traits:\n• Enervation\n• Fracture\n• Ravage Health\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift der Lebensschändung IX mit bestimmten Eigenschaften her.\n\n• Schwäche\n• Fraktur\n• Lebensverwüstung\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison de ravage de Santé IX avec les traits suivants : \n• Affaiblissement\n• Fracture\n• Réduit la Santé\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno de daño a la salud IX con las siguientes propiedades:• Debilitación• Fracture• Reducción de salud\n• Progreso: 0/20"
          ,   it  = "Crea un Damage Health Poison con i seguenti tratti:\n• Enervation\n• Fracture\n• Ravage Health\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Damage Health Poison IX) со следующими эффектами:\n• Слабость\n• Перелом\n• Опустошение здоровья\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 体力減少の毒 9 with the following Traits:\n• 弱体化\n• 破砕\n• 体力減少\n• Progress: 0 / 20"
          }
, [869] = {
              key = "$MASTER_COND_0007"
          ,   en  = "Craft a Rubedite Maul with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: Daedric Trickery\n• Style: Argonian\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubeditstreitkolben mit bestimmten Eigenschaften her.\n• Set: Daedrische Gaunerei\n• Stil: Argonier\n• Eigenschaft: Verteidigend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une masse d'arme en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Défenseur\n• Ensemble : la Tromperie daedrique\n• Style : Argonien\n• Progression : 0/1"
          ,   es  = "Fabricar: Maza de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Defensivo\n• Conjunto: Engaño daédrico\n• Estilo: Argoniano\n• Progreso: 0/1"
          ,   it  = "Crea un Maul con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Difensivo\n• Set: Daedric Trickery\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Maul) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Defending\n• Комплект: Daedric Trickery\n• Стиль: аргонианский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの大槌 with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: デイドラの策略\n• Style: アルゴニアン\n• Progress: 0 / 1"
          }
, [870] = {
              key = "$MASTER_COND_0008"
          ,   en  = "Craft a Rubedite Pauldron with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: Eternal Hunt\n• Style: Wood Elf\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubeditschulterschutz mit bestimmten Eigenschaften her.\n• Set: Ewige Jagd\n• Stil: Waldelfen\n• Eigenschaft: Nirngeschliffen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une Spallière en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : Chasse éternelle\n• Style : Elfe des bois\n• Progression : 0/1"
          ,   es  = "Fabricar: Espaldarones de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Caza Eterna\n• Estilo: Elfo del bosque\n• Progreso: 0/1"
          ,   it  = "Crea un Spallaccio con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Eternal Hunt\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Pauldron) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Eternal Hunt\n• Стиль: босмерский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのポールドロン with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: エターナルハント\n• Style: ウッドエルフ\n• Progress: 0 / 1"
          }
, [871] = {
              key = "$MASTER_COND_0009"
          ,   en  = "Craft a Rubedo Leather Helmet with the following Properties:\n• Quality: Epic\n• Trait: Well-Fitted\n• Set: Kagrenac's Hope\n• Style: Abah's Watch\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubedolederhelm mit bestimmten Eigenschaften her.\n• Set: Kagrenacs Hoffnung\n• Stil: Abahs Wacht\n• Eigenschaft: Passgenau\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un casque en cuir pourpre avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Ajusté\n• Ensemble : l’Espoir de Kagrenac\n• Style : Garde d'Abah\n• Progression : 0/1"
          ,   es  = "Fabricar: Casco de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Ajustado\n• Conjunto: Esperanza de Kagrenac\n• Estilo: Guardia de Abah\n• Progreso: 0/1"
          ,   it  = "Crea un Elmetto con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Comodo\n• Set: Kagrenac's Hope\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Helmet) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Well-fitted\n• Комплект: Kagrenac's Hope\n• Стиль: стража Причала Абы\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーの兜 with the following Properties:\n• Quality: Epic\n• Trait: Well-Fitted\n• Set: カグレナクの希望\n• Style: アバーズ・ウォッチ\n• Progress: 0 / 1"
          }
, [872] = {
              key = "$MASTER_COND_0010"
          ,   en  = "Craft a Superb Glyph of Reduce Feat Cost\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe der Fähigkeitenkostenminderung her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe du virtuose\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de virtuosidad• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Reduce Feat Cost\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Reduce Feat Cost\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (技能消費減少)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [873] = {
              key = "$MASTER_COND_0011"
          ...
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : le Butin du noble\n• Style : Primitif\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Conquista del Noble\n• Estilo: Primitivo\n• Progreso: 0/1"
          ,   it  = "Crea un Scudo con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Noble's Conquest\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Shield) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Noble's Conquest\n• Стиль: первобытный\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの盾 with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: 大親征\n• Style: 野性\n• Progress: 0 / 1"
          }
, [874] = {
              key = "$MASTER_COND_0012"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Healthy\n• Set: Assassin's Guile\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Assassinenlist\n• Eigenschaft: Kräftigend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Sain\n• Ensemble : la Duplicité de l'assassin\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Saludable\n• Conjunto: Astucia de asesino\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Necklace) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Healthy\n• Комплект: Assassin's Guile\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナのネックレス with the following Properties:\n• Quality: Epic\n• Trait: Healthy\n• Set: アサシンの幻惑\n• Progress: 0 / 1"
          }
, [875] = {
              key = "$MASTER_COND_0013"
          ,   en  = "Craft an Orcrest Agony Pale Ale\n• Progress: 0 / 8"
          ,   de  = "Stellt etwas Orkruh-Schmerzbleichale her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez une bière blonde d'agonie d'Orcrête\n• Progression : 0/8"
          ,   es  = "Preparæ cerveza pálida de la agonía de Orcelia\n• Progreso: 0/8"
          ,   it  = "Crea un Orcrest Agony Pale Ale\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nсветлый эль «Агония Оркреста»\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a オークレストの苦悶のペールエール\n• Progress: 0 / 8"
          }
, [876] = {
              key = "$MASTER_COND_0014"
          ,   en  = "Craft a Velothi View Vintage Malbec\n• Progress: 0 / 8"
          ,   de  = "Stellt etwas Velothi-Fernmalbec her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez un vieux cru vélothi de Malbec\n• Progression : 0/8"
          ,   es  = "Preparæ Velothi View Vintage Malbec\n• Progreso: 0/8"
          ,   it  = "Crea un Velothi View Vintage Malbec\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nвыдержанный мальбек «Велотийский \n• Прогресс: 0 / 8"
          ,   ja  = "Craft a ヴェロシビューのビンテージマルベックワイン\n• Progress: 0 / 8"
          }
, [877] = {
              key = "$MASTER_COND_0015"
          ,   en  = "Craft a Rubedite Greatsword with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: Kvatch Gladiator\n• Style: Daggerfall Covenant\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubeditbidenhänder mit bestimmten Eigenschaften her.\n• Set: Gladiator von Kvatch\n• Stil: Dolchsturz-Bündnis\n• Eigenschaft: Verteidigend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une épée longue en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Défenseur\n• Ensemble : le gladiateur de Kvatch\n• Style : Alliance de Daguefilante\n• Progression : 0/1"
          ,   es  = "Fabricar: Mandoble de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Defensivo\n• Conjunto: Gladiador de Kvatch\n• Estilo: Convenio de Daggerfall\n• Progreso: 0/1"
          ,   it  = "Crea un Greatsword con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Difensivo\n• Set: Kvatch Gladiator\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Greatsword) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Defending\n• Комплект: Kvatch Gladiator\n• Стиль: Даггерфольский Ковенант\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの大剣 with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: クヴァッチ剣闘士\n• Style: ダガーフォール・カバナント\n• Progress: 0 / 1"
          }
, [878] = {
              key = "$MASTER_COND_0016"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Bloodthirsty\n• Set: Alessia's Bulwark\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Alessias Bollwerk\n• Eigenschaft: Blutdürstig\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Assoiffé de sang\n• Ensemble : le Rempart d'Alessia\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Sanguinario\n• Conjunto: Baluarte de Alessia\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Necklace) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Bloodthirsty\n• Комплект: Alessia's Bulwark\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナのネックレス with the following Properties:\n• Quality: Epic\n• Trait: Bloodthirsty\n• Set: アレッシア守護\n• Progress: 0 / 1"
          }
, [879] = {
              key = "$MASTER_COND_0017"
          ,   en  = "Craft a Ruby Ash Bow with the following Properties:\n• Quality: Epic\n• Trait: Powered\n• Set: Hist Bark\n• Style: Hlaalu\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenbogen mit bestimmten Eigenschaften her.\n• Set: Histrinde\n• Stil: Hlaalu\n• Eigenschaft: Gestärkt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un arc en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Énergisé\n• Ensemble : l’Écorce d'Hist\n• Style : Hlaalu\n• Progression : 0/1"
          ,   es  = "Fabricar: Arco de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Potenciado\n• Conjunto: Corteza de Hist\n• Estilo: Hlaalu\n• Progreso: 0/1"
          ,   it  = "Crea un Bow con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Potenziato\n• Set: Hist Bark\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Bow) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Powered\n• Комплект: Hist Bark\n• Стиль: Хлаалу\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの弓 with the following Properties:\n• Quality: Epic\n• Trait: Powered\n• Set: ヒスト樹皮\n• Style: フラール\n• Progress: 0 / 1"
          }
, [880] = {
              key = "$MASTER_COND_0018"
          ,   en  = "Craft a Rubedite Pauldron with the following Properties:\n• Quality: Epic\n• Trait: Impenetrable\n• Set: Kvatch Gladiator\n• Style: Pyandonean\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubeditschulterschutz mit bestimmten Eigenschaften her.\n• Set: Gladiator von Kvatch\n• Stil: Pyandonesier\n• Eigenschaft: Undurchdringlich\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une Spallière en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Impénétrable\n• Ensemble : le gladiateur de Kvatch\n• Style : Pyandonéen\n• Progression : 0/1"
          ,   es  = "Fabricar: Espaldarones de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Impenetrable\n• Conjunto: Gladiador de Kvatch\n• Estilo: Pyandoneano\n• Progreso: 0/1"
          ,   it  = "Crea un Spallaccio con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Impenetrabile\n• Set: Kvatch Gladiator\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Pauldron) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Impenetrable\n• Комплект: Kvatch Gladiator\n• Стиль: пиандонейский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのポールドロン with the following Properties:\n• Quality: Epic\n• Trait: Impenetrable\n• Set: クヴァッチ剣闘士\n• Style: ピャンドニア\n• Progress: 0 / 1"
          }
, [881] = {
              key = "$MASTER_COND_0019"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Legendary\n• Trait: Swift\n• Set: Varen's Legacy\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Varens Erbe\n• Eigenschaft: Flink\n• Qualität: Legendär\n• Fortschritt: 0/1"
...
, [883] = {
              key = "$MASTER_COND_0021"
          ,   en  = "Craft an Ancestor Silk Breeches with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: Law of Julianos\n• Style: Morag Tong\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Ahnenseidenbeinkleider mit bestimmten Eigenschaften her.\n• Set: Gesetz von Julianos\n• Stil: Morag Tong\n• Eigenschaft: Erfüllt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Braies en soie ancestrales avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Infusé\n• Ensemble : Loi de Julianos\n• Style : Morag Tong\n• Progression : 0/1"
          ,   es  = "Fabricar: Calzones de seda ancestral con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Imbuido\n• Conjunto: Ley de Julianos\n• Estilo: Morag Tong\n• Progreso: 0/1"
          ,   it  = "Crea un Calzoni con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Infuso\n• Set: Law of Julianos\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ancestor Silk Breeches) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Infused\n• Комплект: Law of Julianos\n• Стиль: Мораг Тонг\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 先人のシルクのパンツ with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: ジュリアノスの掟\n• Style: モラグ・トング\n• Progress: 0 / 1"
          }
, [884] = {
              key = "$MASTER_COND_0022"
          ,   en  = "Craft a Rubedo Leather Bracers with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: Noble's Conquest\n• Style: Mercenary\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedolederarmschienen mit bestimmten Eigenschaften her.\n• Set: Adelssieg\n• Stil: Söldner\n• Eigenschaft: Nirngeschliffen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Brassards en cuir pourpres avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : le Butin du noble\n• Style : Mercenaire\n• Progression : 0/1"
          ,   es  = "Fabricar: Brazales de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Conquista del Noble\n• Estilo: Mercenario\n• Progreso: 0/1"
          ,   it  = "Crea un Bracciali con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Noble's Conquest\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Bracers) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Noble's Conquest\n• Стиль: наемнический\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーの腕当て with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: 大親征\n• Style: 傭兵\n• Progress: 0 / 1"
          }
, [885] = {
              key = "$MASTER_COND_0023"
...
, [886] = {
              key = "$MASTER_COND_0024"
          ,   en  = "Craft a Ruby Ash Lightning Staff with the following Properties:\n• Quality: Epic\n• Trait: Powered\n• Set: Eternal Hunt\n• Style: Thieves Guild\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenblitzstab mit bestimmten Eigenschaften her.\n• Set: Ewige Jagd\n• Stil: Diebesgilde\n• Eigenschaft: Gestärkt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Bâton de foudre en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Énergisé\n• Ensemble : Chasse éternelle\n• Style : Guilde des voleurs\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara eléctrica de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Potenciado\n• Conjunto: Caza Eterna\n• Estilo: Gremio de Ladrones\n• Progreso: 0/1"
          ,   it  = "Crea un Lightning Staff con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Potenziato\n• Set: Eternal Hunt\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Lightning Staff) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Powered\n• Комплект: Eternal Hunt\n• Стиль: Гильдия воров\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの稲妻の杖 with the following Properties:\n• Quality: Epic\n• Trait: Powered\n• Set: エターナルハント\n• Style: 盗賊ギルド\n• Progress: 0 / 1"
          }
, [887] = {
              key = "$MASTER_COND_0025"
          ,   en  = "Craft a Rubedite Axe with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: Daedric Trickery\n• Style: Akaviri\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubeditaxt mit bestimmten Eigenschaften her.\n• Set: Daedrische Gaunerei\n• Stil: Akaviri\n• Eigenschaft: Geschärft\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une hache en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Acéré\n• Ensemble : la Tromperie daedrique\n• Style : Akavirois\n• Progression : 0/1"
          ,   es  = "Fabricar: Hacha de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Afilado\n• Conjunto: Engaño daédrico\n• Estilo: Akaviri\n• Progreso: 0/1"
          ,   it  = "Crea un Axe con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Affilato\n• Set: Daedric Trickery\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Axe) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Sharpened\n• Комплект: Daedric Trickery\n• Стиль: акавирский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの斧 with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: デイドラの策略\n• Style: アカヴィリ\n• Progress: 0 / 1"
          }
, [888] = {
              key = "$MASTER_COND_0026"
          ...
          ,   ru  = "Создать предмет (Ancestor Silk Sash) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Well-fitted\n• Комплект: Alessia's Bulwark\n• Стиль: древнеэльфийский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 先人のシルクのサッシュ with the following Properties:\n• Quality: Epic\n• Trait: Well-Fitted\n• Set: アレッシア守護\n• Style: 古代エルフ\n• Progress: 0 / 1"
          }
, [889] = {
              key = "$MASTER_COND_0027"
          ,   en  = "Craft a Superb Glyph of Decrease Spell Harm\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe des verringerten magischen Schadens her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe de résistance magique\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de resistencia al daño mágico• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Decrease Spell Harm\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Decrease Spell Harm\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (呪文耐性)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [890] = {
              key = "$MASTER_COND_0028"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Robust\n• Set: Kvatch Gladiator\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Gladiator von Kvatch\n• Eigenschaft: Robust\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Robuste\n• Ensemble : le gladiateur de Kvatch\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Robusto\n• Conjunto: Gladiador de Kvatch\n\n• Progreso: 0/1"
...
, [891] = {
              key = "$MASTER_COND_0029"
          ,   en  = "Craft a Stealth-Draining Poison IX with the following Traits:\n• Restore Magicka\n• Increase Spell Power\n• Detection\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift des Schleichentzugs IX mit bestimmten Eigenschaften her.\n\n• Magicka wiederherstellen\n• Erhöht Magiekraft\n• Detektion\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison de drain de Furtivité IX avec les traits suivants : \n• Rend de la Magie\n• Augmente la puissance des sorts\n• De détection\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno de absorción de sigilo IX con las siguientes propiedades:• Restauración de magia• Aumento de poder mágico• Detección\n• Progreso: 0/20"
          ,   it  = "Crea un Stealth-Draining Poison con i seguenti tratti:\n• Restore Magicka\n• Increase Spell Power\n• Detection\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Stealth-Draining Poison IX) со следующими эффектами:\n• Восстановление магии\n• Увеличение силы заклинаний\n• Обнаружение\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a ステルス吸収の毒 9 with the following Traits:\n• マジカ回復\n• 呪文攻撃力上昇\n• 探知\n• Progress: 0 / 20"
          }
, [892] = {
              key = "$MASTER_COND_0030"
          ,   en  = "Craft a Ruby Ash Shield with the following Properties:\n• Quality: Epic\n• Trait: Invigorating\n• Set: Shacklebreaker\n• Style: Aldmeri Dominion\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenschild mit bestimmten Eigenschaften her.\n• Set: Kettensprenger\n• Stil: Aldmeri-Dominion\n• Eigenschaft: Belebend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Revigorant\n• Ensemble : le Brise-entraves\n• Style : Domaine aldmeri\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Vigorizante\n• Conjunto: Rompecadenas\n• Estilo: Dominio Aldmeri\n• Progreso: 0/1"
          ,   it  = "Crea un Scudo con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Prospero\n• Set: Shacklebreaker\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Shield) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Invigorating\n• Комплект: Shacklebreaker\n• Стиль: Альдмерский Доминион\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの盾 with the following Properties:\n• Quality: Epic\n• Trait: Invigorating\n• Set: シャックルブレイカー\n• Style: アルドメリ・ドミニオン\n• Progress: 0 / 1"
          }
, [893] = {
              key = "$MASTER_COND_0031"
          ,   en  = "Craft a Rubedo Leather Guards with the following Properties:\n• Quality: Epic\n• Trait: Divines\n• Set: Oblivion's Foe\n• Style: Primal\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedolederschoner mit bestimmten Eigenschaften her.\n• Set: Erinnerung\n• Stil: Wilde\n• Eigenschaft: Göttlich\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Gardes en cuir pourpres avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Divins\n• Ensemble : l’Adversaire d'Oblivion\n• Style : Primitif\n• Progression : 0/1"
          ,   es  = "Fabricar: Musleras de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Divino\n• Conjunto: Enemigo de Oblivion\n• Estilo: Primitivo\n• Progreso: 0/1"
          ,   it  = "Crea un Pantaloni con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Divino\n• Set: Oblivion's Foe\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Guards) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Divines\n• Комплект: Oblivion's Foe\n• Стиль: первобытный\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーのすね当て with the following Properties:\n• Quality: Epic\n• Trait: Divines\n• Set: 反オブリビオン\n• Style: 野性\n• Progress: 0 / 1"
          }
, [894] = {
              key = "$MASTER_COND_0032"
          ,   en  = "Craft a Rubedite Gauntlets with the following Properties:\n• Quality: Epic\n• Trait: Sturdy\n• Set: Armor of the Seducer\n• Style: Draugr\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedithentzen mit bestimmten Eigenschaften her.\n• Set: Rüstung der Verführung\n• Stil: Draugr\n• Eigenschaft: Robust\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Gantelets en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Solide\n• Ensemble : l’Armure de la séductrice\n• Style : Draugr\n• Progression : 0/1"
          ,   es  = "Fabricar: Guanteletes de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Resistente\n• Conjunto: Armadura de la Seductora\n• Estilo: Draugr\n• Progreso: 0/1"
          ,   it  = "Crea un Gauntlets con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Robusto\n• Set: Armatura della Seduttrice\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Gauntlets) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Sturdy\n• Комплект: Armor of the Seducer\n• Стиль: драугрский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの篭手 with the following Properties:\n• Quality: Epic\n• Trait: Sturdy\n• Set: 誘惑者の武具\n• Style: ドラウグル\n• Progress: 0 / 1"
          }
, [895] = {
              key = "$MASTER_COND_0033"
          ...
          ,   fr  = "Fabriquez un Anneau en platine avec les caractéristiques suivantes : \n• Qualité : Légendaire\n• Trait : Vif\n• Ensemble : l’Étreinte du crépuscule\n• Progression : 0/1"
          ,   es  = "Fabricar: Anillo de platino con los siguientes rasgos: \n• Calidad: Legendario\n• Rasgo: Ágil\n• Conjunto: Abrazo del Crepúsculo\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Ring) со следующими характеристиками:\n• Качество: Легендарное\n• Особенность: Swift\n• Комплект: Twilight's Embrace\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナの指輪 with the following Properties:\n• Quality: Legendary\n• Trait: Swift\n• Set: 黄昏の抱擁\n• Progress: 0 / 1"
          }
, [896] = {
              key = "$MASTER_COND_0034"
          ,   en  = "Craft a Platinum Ring with the following Properties:\n• Quality: Legendary\n• Trait: Bloodthirsty\n• Set: Magnus' Gift\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinring mit bestimmten Eigenschaften her.\n• Set: Magnus' Gabe\n• Eigenschaft: Blutdürstig\n• Qualität: Legendär\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Anneau en platine avec les caractéristiques suivantes : \n• Qualité : Légendaire\n• Trait : Assoiffé de sang\n• Ensemble : le Présent de Magnus\n• Progression : 0/1"
          ,   es  = "Fabricar: Anillo de platino con los siguientes rasgos: \n• Calidad: Legendario\n• Rasgo: Sanguinario\n• Conjunto: Regalo de Magnus\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Ring) со следующими характеристиками:\n• Качество: Легендарное\n• Особенность: Bloodthirsty\n• Комплект: Magnus' Gift\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナの指輪 with the following Properties:\n• Quality: Legendary\n• Trait: Bloodthirsty\n• Set: マグナスの贈物\n• Progress: 0 / 1"
          }
, [897] = {
              key = "$MASTER_COND_0035"
          ,   en  = "Craft a Rubedite Helm with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: Death's Wind\n• Style: Worm Cult\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubedithaube mit bestimmten Eigenschaften her.\n• Set: Todeswind\n• Stil: Wurmkult\n• Eigenschaft: Lehrend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un casque en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Entraînement\n• Ensemble : le Vent mortel\n• Style : Culte du Ver\n• Progression : 0/1"
          ,   es  = "Fabricar: Casco de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Adiestramiento\n• Conjunto: Viento Efímero\n• Estilo: Culto del Gusano\n• Progreso: 0/1"
          ,   it  = "Crea un Elmo con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: da Allenamento\n• Set: Death's Wind\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Helm) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Training\n• Комплект: Death's Wind\n• Стиль: культ Червя\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの兜 with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: 死を招く風\n• Style: 虫の教団\n• Progress: 0 / 1"
          }
, [898] = {
              key = "$MASTER_COND_0036"
          ,   en  = "Craft a Ruby Ash Lightning Staff with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: Hist Bark\n• Style: Order of the Hour\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenblitzstab mit bestimmten Eigenschaften her.\n• Set: Histrinde\n• Stil: Orden der Stunde\n• Eigenschaft: Verteidigend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Bâton de foudre en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Défenseur\n• Ensemble : l’Écorce d'Hist\n• Style : Ordre des Heures\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara eléctrica de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Defensivo\n• Conjunto: Corteza de Hist\n• Estilo: Orden de las Horas\n• Progreso: 0/1"
          ,   it  = "Crea un Lightning Staff con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Difensivo\n• Set: Hist Bark\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Lightning Staff) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Defending\n• Комплект: Hist Bark\n• Стиль: Часовой орден\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの稲妻の杖 with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: ヒスト樹皮\n• Style: 時の騎士団\n• Progress: 0 / 1"
          }
, [899] = {
              key = "$MASTER_COND_0037"
          ,   en  = "Craft an Ancestor Silk Epaulets with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: Spectre's Eye\n• Style: Ebonshadow\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Ahnenseidenschulterpolster mit bestimmten Eigenschaften her.\n• Set: Schemenauge\n• Stil: Ebenschatten\n• Eigenschaft: Erfüllt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Épaulettes en soie ancestrales avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Infusé\n• Ensemble : l’Œil du spectre\n• Style : Ombrébène\n• Progression : 0/1"
          ,   es  = "Fabricar: Cubrehombros de seda ancestral con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Imbuido\n• Conjunto: Ojo del Espectro\n• Estilo: Sombra de Ébano\n• Progreso: 0/1"
          ,   it  = "Crea un Coprispalle con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Infuso\n• Set: Spectre's Eye\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ancestor Silk Epaulets) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Infused\n• Комплект: Spectre's Eye\n• Стиль: эбонитовая тень\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 先人のシルクの肩当て with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: 霊なる瞳\n• Style: エボンシャドウ\n• Progress: 0 / 1"
          }
, [900] = {
              key = "$MASTER_COND_0038"
          ,   en  = "Craft an Orzorga's Tripe Trifle Pocket\n• Progress: 0 / 8"
          ,   de  = "Stellt Orzorgas kleines Schundtäschchen her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez un charlotte aux tripes d'Orzorga\n• Progression : 0/8"
          ,   es  = "Preparæ callos con todo de Ozorga\n• Progreso: 0/8"
          ,   it  = "Crea un Orzorga's Tripe Trifle Pocket\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nхлебный конверт с требухой от Орзо\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a オーゾーガの牛の内臓ミンチ入りのパン\n• Progress: 0 / 8"
          }
, [901] = {
              key = "$MASTER_COND_0039"
          ,   en  = "Craft a Damage Health Poison IX with the following Traits:\n• Gradual Ravage Health\n• Ravage Health\n• Ravage Stamina\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift der Lebensschändung IX mit bestimmten Eigenschaften her.\n\n• Langsame Lebensverwüstung\n• Lebensverwüstung\n• Ausdauerverwüstung\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison de ravage de Santé IX avec les traits suivants : \n• Ravage de Santé graduel\n• Réduit la Santé\n• Ravage de Vigueur\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno de daño a la salud IX con las siguientes propiedades:• Reducción de salud insidioso• Reducción de salud• Reducción de aguante\n• Progreso: 0/20"
          ,   it  = "Crea un Damage Health Poison con i seguenti tratti:\n• Gradual Ravage Health\n• Ravage Health\n• Ravage Stamina\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Damage Health Poison IX) со следующими эффектами:\n• Постепенное опустош. здоровья\n• Опустошение здоровья\n• Опустошение запаса сил\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 体力減少の毒 9 with the following Traits:\n• 体力漸減\n• 体力減少\n• スタミナ減少\n• Progress: 0 / 20"
          }
, [902] = {
              key = "$MASTER_COND_0040"
          ,   en  = "Craft a Superb Glyph of Flame Resist\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe der Flammenresistenz her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe ignifugé\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de resistencia al fuego• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Flame Resist\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Flame Resist\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (炎耐性)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [903] = {
              key = "$MASTER_COND_0041"
          ,   en  = "Craft a Rubedite Dagger with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: Assassin's Guile\n• Style: Dwemer\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubeditdolch mit bestimmten Eigenschaften her.\n• Set: Assassinenlist\n• Stil: Dwemer\n• Eigenschaft: Geschärft\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une dague en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Acéré\n• Ensemble : la Duplicité de l'assassin\n• Style : Dwemer\n• Progression : 0/1"
          ,   es  = "Fabricar: Daga de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Afilado\n• Conjunto: Astucia de asesino\n• Estilo: Dwemer\n• Progreso: 0/1"
          ,   it  = "Crea un Dagger con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Affilato\n• Set: Assassin's Guile\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Dagger) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Sharpened\n• Комплект: Assassin's Guile\n• Стиль: двемерский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの短剣 with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: アサシンの幻惑\n• Style: ドゥエマー\n• Progress: 0 / 1"
          }
, [904] = {
              key = "$MASTER_COND_0042"
          ,   en  = "Craft a Ruby Ash Shield with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: Song of Lamae\n• Style: Nord\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenschild mit bestimmten Eigenschaften her.\n• Set: Lied der Lamien\n• Stil: Nord\n• Eigenschaft: Erfüllt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Infusé\n• Ensemble : le Chant de Lamae\n• Style : Nordique\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Imbuido\n• Conjunto: Canción de Lamae\n• Estilo: Nórdico\n• Progreso: 0/1"
          ,   it  = "Crea un Scudo con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Infuso\n• Set: Song of Lamae\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Shield) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Infused\n• Комплект: Song of Lamae\n• Стиль: нордский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの盾 with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: ラマエ歌\n• Style: ノルド\n• Progress: 0 / 1"
          }
, [905] = {
              key = "$MASTER_COND_0043"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Bloodthirsty\n• Set: Oblivion's Foe\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Erinnerung\n• Eigenschaft: Blutdürstig\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Assoiffé de sang\n• Ensemble : l’Adversaire d'Oblivion\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Sanguinario\n• Conjunto: Enemigo de Oblivion\n\n• Progreso: 0/1"
...
, [906] = {
              key = "$MASTER_COND_0044"
          ,   en  = "Craft a Rubedo Leather Boots with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: Song of Lamae\n• Style: Ebonheart Pact\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedolederstiefel mit bestimmten Eigenschaften her.\n• Set: Lied der Lamien\n• Stil: Ebenherz-Pakt\n• Eigenschaft: Lehrend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Bottes en cuir pourpres avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Entraînement\n• Ensemble : le Chant de Lamae\n• Style : Pacte de Cœurébène\n• Progression : 0/1"
          ,   es  = "Fabricar: Botas de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Adiestramiento\n• Conjunto: Canción de Lamae\n• Estilo: Pacto de Ebonheart\n• Progreso: 0/1"
          ,   it  = "Crea un Stivali con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: da Allenamento\n• Set: Song of Lamae\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Boots) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Training\n• Комплект: Song of Lamae\n• Стиль: Эбонхартский Пакт\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーのブーツ with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: ラマエ歌\n• Style: エボンハート・パクト\n• Progress: 0 / 1"
          }
, [907] = {
              key = "$MASTER_COND_0045"
          ,   en  = "Craft a Ruby Ash Inferno Staff with the following Properties:\n• Quality: Epic\n• Trait: Precise\n• Set: Hist Bark\n• Style: Malacath\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenflammenstab mit bestimmten Eigenschaften her.\n• Set: Histrinde\n• Stil: Malacath\n• Eigenschaft: Präzise\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bâton infernal en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Précis\n• Ensemble : l’Écorce d'Hist\n• Style : Malacath\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara infernal de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Preciso\n• Conjunto: Corteza de Hist\n• Estilo: Malacath\n• Progreso: 0/1"
          ,   it  = "Crea un Bastone del Fuoco con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Preciso\n• Set: Hist Bark\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Inferno Staff) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Precise\n• Комплект: Hist Bark\n• Стиль: Малакат\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの業火の杖 with the following Properties:\n• Quality: Epic\n• Trait: Precise\n• Set: ヒスト樹皮\n• Style: マラキャス\n• Progress: 0 / 1"
          }
, [908] = {
              key = "$MASTER_COND_0046"
          ,   en  = "Craft an Ancestor Silk Breeches with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: Magnus' Gift\n• Style: Dark Brotherhood\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Ahnenseidenbeinkleider mit bestimmten Eigenschaften her.\n• Set: Magnus' Gabe\n• Stil: Dunkle Bruderschaft\n• Eigenschaft: Lehrend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Braies en soie ancestrales avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Entraînement\n• Ensemble : le Présent de Magnus\n• Style : Confrérie noire\n• Progression : 0/1"
          ,   es  = "Fabricar: Calzones de seda ancestral con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Adiestramiento\n• Conjunto: Regalo de Magnus\n• Estilo: Hermandad Oscura\n• Progreso: 0/1"
          ,   it  = "Crea un Calzoni con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: da Allenamento\n• Set: Magnus' Gift\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ancestor Silk Breeches) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Training\n• Комплект: Magnus' Gift\n• Стиль: Темное Братство\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 先人のシルクのパンツ with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: マグナスの贈物\n• Style: 闇の一党\n• Progress: 0 / 1"
          }
, [909] = {
              key = "$MASTER_COND_0047"
          ...
          ,   es  = "Fabricæ una esencia de reducción de salud con las siguientes propiedades:• Debilitación• Fracture• Reducción de salud\n• Progreso: 0/20"
...
, [910] = {
              key = "$MASTER_COND_0048"
          ,   en  = "Craft a Superb Glyph of Weakening\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe der Schwächung her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe affaiblissant\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de debilidad• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Weakening\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Weakening\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (衰弱)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [911] = {
              key = "$MASTER_COND_0049"
          ,   en  = "Craft a Senche-Tiger Single Malt\n• Progress: 0 / 8"
          ,   de  = "Stellt etwas Senchetiger-Whiskey her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez un single malt du tigre-senche\n• Progression : 0/8"
          ,   es  = "Preparæ Senche-Tiger Single Malt\n• Progreso: 0/8"
          ,   it  = "Crea un Senche-Tiger Single Malt\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nодносолодовый виски «Сенч-тигр»\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a センチタイガーのシングルモルト\n• Progress: 0 / 8"
          }
, [912] = {
              key = "$MASTER_COND_0050"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Bloodthirsty\n• Set: Eyes of Mara\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Augen von Mara\n• Eigenschaft: Blutdürstig\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Assoiffé de sang\n• Ensemble : les Yeux de Mara\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Sanguinario\n• Conjunto: Ojos de Mara\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Necklace) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Bloodthirsty\n• Комплект: Eyes of Mara\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナのネックレス with the following Properties:\n• Quality: Epic\n• Trait: Bloodthirsty\n• Set: マーラの目\n• Progress: 0 / 1"
          }
, [913] = {
              key = "$MASTER_COND_0051"
          ,   en  = "Craft a Rubedite Mace with the following Properties:\n• Quality: Epic\n• Trait: Charged\n• Set: Kagrenac's Hope\n• Style: Dark Elf\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubeditkeule mit bestimmten Eigenschaften her.\n• Set: Kagrenacs Hoffnung\n• Stil: Dunkelelfen\n• Eigenschaft: Geladen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une masse en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Chargé\n• Ensemble : l’Espoir de Kagrenac\n• Style : Elfe noir\n• Progression : 0/1"
          ,   es  = "Fabricar: Maza de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Cargado\n• Conjunto: Esperanza de Kagrenac\n• Estilo: Elfo oscuro\n• Progreso: 0/1"
          ,   it  = "Crea un Mace con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Carico\n• Set: Kagrenac's Hope\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Mace) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Charged\n• Комплект: Kagrenac's Hope\n• Стиль: данмерский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのメイス with the following Properties:\n• Quality: Epic\n• Trait: Charged\n• Set: カグレナクの希望\n• Style: ダークエルフ\n• Progress: 0 / 1"
          }
, [914] = {
              key = "$MASTER_COND_0052"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Epic\n• Trait: Harmony\n• Set: Orgnum's Scales\n• Progress: 0 / 1"
...
, [915] = {
              key = "$MASTER_COND_0053"
          ,   en  = "Craft a Rubedite Helm with the following Properties:\n• Quality: Epic\n• Trait: Sturdy\n• Set: Twice-Born Star\n• Style: Psijic Order\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubedithaube mit bestimmten Eigenschaften her.\n• Set: Doppelstern\n• Stil: Psijik-Orden\n• Eigenschaft: Robust\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un casque en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Solide\n• Ensemble : Étoile gémellaire\n• Style : Ordre psijique\n• Progression : 0/1"
          ,   es  = "Fabricar: Casco de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Resistente\n• Conjunto: Estrella renacida\n• Estilo: Orden Psijic\n• Progreso: 0/1"
          ,   it  = "Crea un Elmo con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Robusto\n• Set: Twice-Born Star\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Helm) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Sturdy\n• Комплект: Twice-Born Star\n• Стиль: орден Псиджиков\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの兜 with the following Properties:\n• Quality: Epic\n• Trait: Sturdy\n• Set: 双子星\n• Style: サイジック\n• Progress: 0 / 1"
          }
, [916] = {
              key = "$MASTER_COND_0054"
          ,   en  = "Craft a Psijic Ambrosia\n• Progress: 0 / 8"
          ,   de  = "Stellt etwas Psijik-Ambrosia her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez une ambroisie psijique\n• Progression : 0/8"
          ,   es  = "Preparæ ambrosía psijic\n• Progreso: 0/8"
          ,   it  = "Crea un Psijic Ambrosia\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nамброзия Псиджиков\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a サイジックのアンブロージア\n• Progress: 0 / 8"
          }
, [917] = {
              key = "$MASTER_COND_0055"
          ,   en  = "Craft a Ruby Ash Ice Staff with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: Morkuldin\n• Style: Ancient Orc\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenfroststab mit bestimmten Eigenschaften her.\n• Set: Morkuldin\n• Stil: Orkahnen\n• Eigenschaft: Verteidigend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Bâton de glace en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Défenseur\n• Ensemble : Morkuldin\n• Style : Orque ancien\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara glaciar de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Defensivo\n• Conjunto: Morkuldin\n• Estilo: Orco antiguo\n• Progreso: 0/1"
          ,   it  = "Crea un Frost Staff con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Difensivo\n• Set: Morkuldin\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ruby Ash Ice Staff) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Defending\n• Комплект: Morkuldin\n• Стиль: древнеорочий\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルビーアッシュの氷の杖 with the following Properties:\n• Quality: Epic\n• Trait: Defending\n• Set: モークルディン\n• Style: 古代オーク\n• Progress: 0 / 1"
          }
, [918] = {
              key = "$MASTER_COND_0056"
          ,   en  = "Craft a Rubedo Leather Boots with the following Properties:\n• Quality: Epic\n• Trait: Divines\n• Set: Law of Julianos\n• Style: Dwemer\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedolederstiefel mit bestimmten Eigenschaften her.\n• Set: Gesetz von Julianos\n• Stil: Dwemer\n• Eigenschaft: Göttlich\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Bottes en cuir pourpres avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Divins\n• Ensemble : Loi de Julianos\n• Style : Dwemer\n• Progression : 0/1"
          ,   es  = "Fabricar: Botas de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Divino\n• Conjunto: Ley de Julianos\n• Estilo: Dwemer\n• Progreso: 0/1"
...
, [919] = {
              key = "$MASTER_COND_0057"
          ,   en  = "Craft an Essence of Detection with the following Traits:\n• Restore Magicka\n• Increase Spell Power\n• Detection\n• Progress: 0 / 20"
          ,   de  = "Stellt eine Essenz der Detektion mit bestimmten Eigenschaften her.\n\n• Magicka wiederherstellen\n• Erhöht Magiekraft\n• Detektion\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez une essence de détection avec les traits suivants : \n• Rend de la Magie\n• Augmente la puissance des sorts\n• De détection\n• Progression : 0/20"
          ,   es  = "Fabricæ una esencia de detección con las siguientes propiedades:• Restauración de magia• Aumento de poder mágico• Detección\n• Progreso: 0/20"
          ,   it  = "Crea un Detection con i seguenti tratti:\n• Restore Magicka\n• Increase Spell Power\n• Detection\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Essence of Detection) со следующими эффектами:\n• Восстановление магии\n• Увеличение силы заклинаний\n• Обнаружение\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 探知 のエキス with the following Traits:\n• マジカ回復\n• 呪文攻撃力上昇\n• 探知\n• Progress: 0 / 20"
          }
, [920] = {
              key = "$MASTER_COND_0058"
          ,   en  = "Craft an Orzorga's Smoked Bear Haunch\n• Progress: 0 / 8"
          ,   de  = "Stellt Orzorgas geräucherte Bärenlende her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez un cuissot d'ours fumé d'Orzorga\n• Progression : 0/8"
          ,   es  = "Preparæ Pierna de oso ahumada de Orzorga\n• Progreso: 0/8"
          ,   it  = "Crea un Orzorga's Smoked Bear Haunch\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nкопченый медвежий окорок от Орзор�\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a オーゾーガの熊の腰肉の燻製\n• Progress: 0 / 8"
          }
, [921] = {
              key = "$MASTER_COND_0059"
          ,   en  = "Craft a Ruby Ash Shield with the following Properties:\n• Quality: Epic\n• Trait: Sturdy\n• Set: Eyes of Mara\n• Style: Daedric\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenschild mit bestimmten Eigenschaften her.\n• Set: Augen von Mara\n• Stil: Daedra\n• Eigenschaft: Robust\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Solide\n• Ensemble : les Yeux de Mara\n• Style : Daedrique\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Resistente\n• Conjunto: Ojos de Mara\n• Estilo: Daédrico\n• Progreso: 0/1"
...
, [922] = {
              key = "$MASTER_COND_0060"
          ,   en  = "Craft an Escapist's Poison IX with the following Traits:\n• Unstoppable\n• Restore Magicka\n• Spell Critical\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift des Fliehenden IX mit bestimmten Eigenschaften her.\n\n• Sicherer Stand\n• Magicka wiederherstellen\n• Kritische Magietreffer\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison du monte-en-l'air IX avec les traits suivants : \n• Implacable\n• Rend de la Magie\n• Critique de sorts\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno del escapista IX con las siguientes propiedades:• Imparable• Restauración de magia• Crítico mágico\n• Progreso: 0/20"
          ,   it  = "Crea un Escapist's Poison con i seguenti tratti:\n• Unstoppable\n• Restore Magicka\n• Spell Critical\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Escapist's Poison IX) со следующими эффектами:\n• Неудержимость\n• Восстановление магии\n• Критический урон заклинаниями\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 逃避者の毒 9 with the following Traits:\n• 猪突猛進\n• マジカ回復\n• 呪文クリティカル\n• Progress: 0 / 20"
          }
, [923] = {
              key = "$MASTER_COND_0061"
          ,   en  = "Craft a Rubedite Mace with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: Ashen Grip\n• Style: Ancient Elf\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubeditkeule mit bestimmten Eigenschaften her.\n• Set: Aschengriff\n• Stil: Alte Elfen\n• Eigenschaft: Geschärft\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une masse en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Acéré\n• Ensemble : la Poigne de cendres\n• Style : Elfe antique\n• Progression : 0/1"
          ,   es  = "Fabricar: Maza de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Afilado\n• Conjunto: Control de cenizas\n• Estilo: Elfo antiguo\n• Progreso: 0/1"
          ,   it  = "Crea un Mace con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Affilato\n• Set: Ashen Grip\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Mace) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Sharpened\n• Комплект: Ashen Grip\n• Стиль: древнеэльфийский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのメイス with the following Properties:\n• Quality: Epic\n• Trait: Sharpened\n• Set: 青白い柄\n• Style: 古代エルフ\n• Progress: 0 / 1"
          }
, [924] = {
              key = "$MASTER_COND_0062"
          ,   en  = "Craft a Truly Superb Glyph of Reduce Feat Cost\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine wahrlich prächtige Glyphe der Fähigkeitenkostenminderung her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe du virtuose vraiment superbe\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo realmente soberbio de virtuosidad• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Reduce Feat Cost\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nTruly Superb Glyph of Reduce Feat Cost\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 真に最上のグリフ (技能消費減少)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [925] = {
              key = "$MASTER_COND_0063"
          ,   en  = "Craft a Platinum Ring with the following Properties:\n• Quality: Legendary\n• Trait: Bloodthirsty\n• Set: Redistributor\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinring mit bestimmten Eigenschaften her.\n• Set: Umverteilung\n• Eigenschaft: Blutdürstig\n• Qualität: Legendär\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Anneau en platine avec les caractéristiques suivantes : \n• Qualité : Légendaire\n• Trait : Assoiffé de sang\n• Ensemble : Redistributeur\n• Progression : 0/1"
          ,   es  = "Fabricar: Anillo de platino con los siguientes rasgos: \n• Calidad: Legendario\n• Rasgo: Sanguinario\n• Conjunto: Redistribuidor\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Ring) со следующими характеристиками:\n• Качество: Легендарное\n• Особенность: Bloodthirsty\n• Комплект: Redistributor\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナの指輪 with the following Properties:\n• Quality: Legendary\n• Trait: Bloodthirsty\n• Set: 再分配\n• Progress: 0 / 1"
          }
, [926] = {
              key = "$MASTER_COND_0064"
          ,   en  = "Craft an Ancestor Silk Epaulets with the following Properties:\n• Quality: Epic\n• Trait: Impenetrable\n• Set: Tava's Favor\n• Style: Sapiarch\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Ahnenseidenschulterpolster mit bestimmten Eigenschaften her.\n• Set: Tavas Gunst\n• Stil: Sapiarchen\n• Eigenschaft: Undurchdringlich\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Épaulettes en soie ancestrales avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Impénétrable\n• Ensemble : Faveur de Tava\n• Style : Sapiarque\n• Progression : 0/1"
          ,   es  = "Fabricar: Cubrehombros de seda ancestral con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Impenetrable\n• Conjunto: Favor de Tava\n• Estilo: Sapiarca\n• Progreso: 0/1"
          ,   it  = "Crea un Coprispalle con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Impenetrabile\n• Set: Tava's Favor\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Ancestor Silk Epaulets) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Impenetrable\n• Комплект: Tava's Favor\n• Стиль: сапиархи\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 先人のシルクの肩当て with the following Properties:\n• Quality: Epic\n• Trait: Impenetrable\n• Set: ターヴァの寵\n• Style: サピアルチ\n• Progress: 0 / 1"
          }
, [927] = {
              key = "$MASTER_COND_0065"
          ,   en  = "Craft a Longfin Pasty with Melon Sauce\n• Progress: 0 / 8"
          ,   de  = "Stellt eine Langflossenpastete mit Melonensoße her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez un friand de nagelongue à la sauce au melon\n• Progression : 0/8"
          ,   es  = "Preparæ Longfin Pasty with Melon Sauce\n• Progreso: 0/8"
          ,   it  = "Crea un Longfin Pasty with Melon Sauce\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nхлебный конверт с окунем в дынном �\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a ロングフィンのパイのメロンソース添え\n• Progress: 0 / 8"
          }
, [928] = {
              key = "$MASTER_COND_0066"
          ,   en  = "Craft a Ruby Ash Shield with the following Properties:\n• Quality: Epic\n• Trait: Infused\n• Set: Armor of the Seducer\n• Style: Dark Brotherhood\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenschild mit bestimmten Eigenschaften her.\n• Set: Rüstung der Verführung\n• Stil: Dunkle Bruderschaft\n• Eigenschaft: Erfüllt\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Infusé\n• Ensemble : l’Armure de la séductrice\n• Style : Confrérie noire\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Imbuido\n• Conjunto: Armadura de la Seductora\n• Estilo: Hermandad Oscura\n• Progreso: 0/1"
...
, [929] = {
              key = "$MASTER_COND_0067"
          ,   en  = "Craft a Rubedite Greaves with the following Properties:\n• Quality: Epic\n• Trait: Divines\n• Set: Kagrenac's Hope\n• Style: Redoran\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubeditbeinschienen mit bestimmten Eigenschaften her.\n• Set: Kagrenacs Hoffnung\n• Stil: Redoran\n• Eigenschaft: Göttlich\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Grèves en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Divins\n• Ensemble : l’Espoir de Kagrenac\n• Style : Redoran\n• Progression : 0/1"
          ,   es  = "Fabricar: Grebas de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Divino\n• Conjunto: Esperanza de Kagrenac\n• Estilo: Redoran\n• Progreso: 0/1"
          ,   it  = "Crea un Gambali con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Divino\n• Set: Kagrenac's Hope\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Greaves) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Divines\n• Комплект: Kagrenac's Hope\n• Стиль: редоранский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのグリーヴ with the following Properties:\n• Quality: Epic\n• Trait: Divines\n• Set: カグレナクの希望\n• Style: レドラン\n• Progress: 0 / 1"
          }
, [930] = {
              key = "$MASTER_COND_0068"
          ,   en  = "Craft a Rubedo Leather Arm Cops with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: Oblivion's Foe\n• Style: Ancient Elf\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubedolederschulterkappen mit bestimmten Eigenschaften her.\n• Set: Erinnerung\n• Stil: Alte Elfen\n• Eigenschaft: Lehrend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Coques d'épaules en cuir pourpres avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Entraînement\n• Ensemble : l’Adversaire d'Oblivion\n• Style : Elfe antique\n• Progression : 0/1"
          ,   es  = "Fabricar: Hombreras de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Adiestramiento\n• Conjunto: Enemigo de Oblivion\n• Estilo: Elfo antiguo\n• Progreso: 0/1"
          ,   it  = "Crea un Spalline con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: da Allenamento\n• Set: Oblivion's Foe\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Arm Cops) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Training\n• Комплект: Oblivion's Foe\n• Стиль: древнеэльфийский\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーのアームカップ with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: 反オブリビオン\n• Style: 古代エルフ\n• Progress: 0 / 1"
          }
, [931] = {
              key = "$MASTER_COND_0069"
          ,   en  = "Craft a Truly Superb Glyph of Weakening\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine wahrlich prächtige Glyphe der Schwächung her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe affaiblissant vraiment superbe\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo realmente soberbio de debilidad• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Weakening\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nTruly Superb Glyph of Weakening\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 真に最上のグリフ (衰弱)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [932] = {
              key = "$MASTER_COND_0070"
          ,   en  = "Craft a Platinum Ring with the following Properties:\n• Quality: Epic\n• Trait: Protective\n• Set: Night Mother's Gaze\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinring mit bestimmten Eigenschaften her.\n• Set: Blick der Mutter der Nacht\n• Eigenschaft: Schützend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Anneau en platine avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Protecteur\n• Ensemble : le Regard de la Mère de la nuit\n• Progression : 0/1"
          ,   es  = "Fabricar: Anillo de platino con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Protector\n• Conjunto: Mirada de la Madre Noche\n\n• Progreso: 0/1"
          ,   ru  = "Создать предмет (platinum Ring) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Protective\n• Комплект: Night Mother's Gaze\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a プラチナの指輪 with the following Properties:\n• Quality: Epic\n• Trait: Protective\n• Set: 夜母の注視\n• Progress: 0 / 1"
          }
, [933] = {
              key = "$MASTER_COND_0071"
          ,   en  = "Craft an Orzorga's Blood Price Pie\n• Progress: 0 / 8"
          ,   de  = "Stellt Orzorgas Blutzoll-Pastete her\n• Fortschritt: 0/8"
          ,   fr  = "Fabriquez une tarte « Prix du sang » d'Orzorga\n• Progression : 0/8"
          ,   es  = "Preparæ Tarta del precio de sangre de Orzorga\n• Progreso: 0/8"
          ,   it  = "Crea un Orzorga's Blood Price Pie\n• Progresso: 0 / 8"
          ,   ru  = "Создать предмет:\nценная корзиночка с кровью от Орзо\n• Прогресс: 0 / 8"
          ,   ja  = "Craft a オーゾーガのブラッド・プライス・パイ\n• Progress: 0 / 8"
          }
, [934] = {
              key = "$MASTER_COND_0072"
          ,   en  = "Craft a Ruby Ash Shield with the following Properties:\n• Quality: Epic\n• Trait: Invigorating\n• Set: Oblivion's Foe\n• Style: Redoran\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenschild mit bestimmten Eigenschaften her.\n• Set: Erinnerung\n• Stil: Redoran\n• Eigenschaft: Belebend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un bouclier en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Revigorant\n• Ensemble : l’Adversaire d'Oblivion\n• Style : Redoran\n• Progression : 0/1"
          ,   es  = "Fabricar: Escudo de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Vigorizante\n• Conjunto: Enemigo de Oblivion\n• Estilo: Redoran\n• Progreso: 0/1"
...
, [935] = {
              key = "$MASTER_COND_0073"
          ,   en  = "Craft a Sorcery-Draining Poison IX with the following Traits:\n• Breach\n• Increase Spell Power\n• Spell Critical\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift des Zaubereientzugs IX mit bestimmten Eigenschaften her.\n\n• Bruch\n• Erhöht Magiekraft\n• Kritische Magietreffer\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison de drain de Sorcellerie IX avec les traits suivants : \n• Brèche\n• Augmente la puissance des sorts\n• Critique de sorts\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno de absorción del hechicero IX con las siguientes propiedades:• La Grieta• Aumento de poder mágico• Crítico mágico\n• Progreso: 0/20"
          ,   it  = "Crea un Sorcery-Draining Poison con i seguenti tratti:\n• Breach\n• Increase Spell Power\n• Spell Critical\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Sorcery-Draining Poison IX) со следующими эффектами:\n• Разрыв\n• Увеличение силы заклинаний\n• Критический урон заклинаниями\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 魔術吸収の毒 9 with the following Traits:\n• 侵害\n• 呪文攻撃力上昇\n• 呪文クリティカル\n• Progress: 0 / 20"
          }
, [936] = {
              key = "$MASTER_COND_0074"
          ,   en  = "Craft a Superb Glyph of Increase Physical Harm\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe des erhöhten physischen Schadens her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe de puissance physique\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de aumento de daño físico• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Increase Physical Harm\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Increase Physical Harm\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (物理攻撃強化)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [937] = {
              key = "$MASTER_COND_0075"
          ,   en  = "Craft an Ancestor Silk Breeches with the following Properties:\n• Quality: Epic\n• Trait: Well-Fitted\n• Set: Kagrenac's Hope\n• Style: Ancient Orc\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Ahnenseidenbeinkleider mit bestimmten Eigenschaften her.\n• Set: Kagrenacs Hoffnung\n• Stil: Orkahnen\n• Eigenschaft: Passgenau\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Braies en soie ancestrales avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Ajusté\n• Ensemble : l’Espoir de Kagrenac\n• Style : Orque ancien\n• Progression : 0/1"
          ,   es  = "Fabricar: Calzones de seda ancestral con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Ajustado\n• Conjunto: Esperanza de Kagrenac\n• Estilo: Orco antiguo\n• Progreso: 0/1"
...
, [939] = {
              key = "$MASTER_COND_0077"
          ,   en  = "Craft a Rubedite Sabatons with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: Daedric Trickery\n• Style: Buoyant Armiger\n• Progress: 0 / 1"
          ,   de  = "Stellt einige Rubeditpanzerschuhe mit bestimmten Eigenschaften her.\n• Set: Daedrische Gaunerei\n• Stil: Kriegswappenträger\n• Eigenschaft: Nirngeschliffen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez des Soleret en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : la Tromperie daedrique\n• Style : Exalté\n• Progression : 0/1"
          ,   es  = "Fabricar: Escarpes de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Engaño daédrico\n• Estilo: Armígero Jovial\n• Progreso: 0/1"
          ,   it  = "Crea un Sabatons con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Daedric Trickery\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Sabatons) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Daedric Trickery\n• Стиль: Вечная стража\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトのサバトン with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: デイドラの策略\n• Style: ボイアント・アーミガー\n• Progress: 0 / 1"
          }
, [940] = {
              key = "$MASTER_COND_0078"
          ,   en  = "Craft a Ruby Ash Lightning Staff with the following Properties:\n• Quality: Epic\n• Trait: Precise\n• Set: Tava's Favor\n• Style: Sapiarch\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubineschenblitzstab mit bestimmten Eigenschaften her.\n• Set: Tavas Gunst\n• Stil: Sapiarchen\n• Eigenschaft: Präzise\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Bâton de foudre en frêne roux avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Précis\n• Ensemble : Faveur de Tava\n• Style : Sapiarque\n• Progression : 0/1"
          ,   es  = "Fabricar: Vara eléctrica de 	fresno rubí con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Preciso\n• Conjunto: Favor de Tava\n• Estilo: Sapiarca\n• Progreso: 0/1"
...
, [941] = {
              key = "$MASTER_COND_0079"
          ,   en  = "Craft a Rubedo Leather Helmet with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: Hunding's Rage\n• Style: Hlaalu\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Rubedolederhelm mit bestimmten Eigenschaften her.\n• Set: Hundings Zorn\n• Stil: Hlaalu\n• Eigenschaft: Lehrend\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un casque en cuir pourpre avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Entraînement\n• Ensemble : la Rage de Hunding\n• Style : Hlaalu\n• Progression : 0/1"
          ,   es  = "Fabricar: Casco de cuero rubedo con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Adiestramiento\n• Conjunto: Rabia de Hunding\n• Estilo: Hlaalu\n• Progreso: 0/1"
          ,   it  = "Crea un Elmetto con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: da Allenamento\n• Set: Hunding's Rage\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedo Leather Helmet) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Training\n• Комплект: Hunding's Rage\n• Стиль: Хлаалу\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベドレザーの兜 with the following Properties:\n• Quality: Epic\n• Trait: Training\n• Set: 怒れるフンディング\n• Style: フラール\n• Progress: 0 / 1"
          }
, [942] = {
              key = "$MASTER_COND_0080"
          ,   en  = "Craft a Rubedite Axe with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: Shalidor's Curse\n• Style: Silken Ring\n• Progress: 0 / 1"
          ,   de  = "Stellt eine Rubeditaxt mit bestimmten Eigenschaften her.\n• Set: Shalidors Fluch\n• Stil: Seidenring\n• Eigenschaft: Nirngeschliffen\n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez une hache en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Trempe de Nirn\n• Ensemble : la Malédiction de Shalidor\n• Style : Anneau de soie\n• Progression : 0/1"
          ,   es  = "Fabricar: Hacha de rubedita con los siguientes rasgos: \n• Calidad: Épico\n• Rasgo: Temple de Nirn\n• Conjunto: Maldición de Shalidor\n• Estilo: Anillo de Seda\n• Progreso: 0/1"
          ,   it  = "Crea un Axe con le seguenti proprietà:\n• Qualità: Epico\n• Tratti: Nirnhoned\n• Set: Shalidor's Curse\n• Stile:\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет (Rubedite Axe) со следующими характеристиками:\n• Качество: Эпическое\n• Особенность: Nirnhoned\n• Комплект: Shalidor's Curse\n• Стиль: Шелковое Кольцо\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a ルベダイトの斧 with the following Properties:\n• Quality: Epic\n• Trait: Nirnhoned\n• Set: 呪えしシャリドール\n• Style: シルケンリング\n• Progress: 0 / 1"
          }
, [943] = {
              key = "$MASTER_COND_0081"
          ,   en  = "Craft a Superb Glyph of Poison\n• Quality: Epic\n• Progress: 0 / 1"
          ,   de  = "Stellt eine prächtige Glyphe des Gifts her \n• Qualität: Episch\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un glyphe superbe empoisonné\n• Qualité : Épique\n• Progression : 0/1"
          ,   es  = "Fabrica un glifo soberbio de veneno• Calidad: Épico\n• Progreso: 0/1"
          ,   it  = "Crea un Glifo of Poison\n• Qualità: Epico\n• Progresso: 0 / 1"
          ,   ru  = "Создать предмет:\nSuperb Glyph of Poison\n• Качество: Эпическое\n• Прогресс: 0 / 1"
          ,   ja  = "Craft a 最上のグリフ (毒)\n• Quality: Epic\n• Progress: 0 / 1"
          }
, [944] = {
              key = "$MASTER_COND_0082"
          ,   en  = "Craft a Damage Health Poison IX with the following Traits:\n• Ravage Health\n• Ravage Magicka\n• Ravage Stamina\n• Progress: 0 / 20"
          ,   de  = "Stellt ein Gift der Lebensschändung IX mit bestimmten Eigenschaften her.\n\n• Lebensverwüstung\n• Magickaverwüstung\n• Ausdauerverwüstung\n• Fortschritt: 0/20"
          ,   fr  = "Fabriquez un Poison de ravage de Santé IX avec les traits suivants : \n• Réduit la Santé\n• Réduit la Magie\n• Ravage de Vigueur\n• Progression : 0/20"
          ,   es  = "Fabricæ un veneno de daño a la salud IX con las siguientes propiedades:• Reducción de salud• Reducción de magia• Reducción de aguante\n• Progreso: 0/20"
          ,   it  = "Crea un Damage Health Poison con i seguenti tratti:\n• Ravage Health\n• Ravage Magicka\n• Ravage Stamina\n• Progresso: 0 / 20"
          ,   ru  = "Создать предмет (Damage Health Poison IX) со следующими эффектами:\n• Опустошение здоровья\n• Опустошение магии\n• Опустошение запаса сил\n• Прогресс: 0 / 20"
          ,   ja  = "Craft a 体力減少の毒 9 with the following Traits:\n• 体力減少\n• マジカ減少\n• スタミナ減少\n• Progress: 0 / 20"
          }
, [945] = {
              key = "$MASTER_COND_0083"
          ,   en  = "Craft a Platinum Necklace with the following Properties:\n• Quality: Legendary\n• Trait: Protective\n• Set: Noble's Conquest\n• Progress: 0 / 1"
          ,   de  = "Stellt einen Platinkette mit bestimmten Eigenschaften her.\n• Set: Adelssieg\n• Eigenschaft: Schützend\n• Qualität: Legendär\n• Fortschritt: 0/1"
          ,   fr  = "Fabriquez un Collier en platine avec les caractéristiques suivantes : \n• Qualité : Légendaire\n• Trait : Protecteur\n• Ensemble : le Butin du noble\n• Progression : 0/1"
          ,   es  = "Fabricar: Collar de platino con los siguientes rasgos: \n• Calidad: Legendario\n• Rasgo: Protector\n• Conjunto: Conquista del Noble\n\n• Progreso: 0/1"
...
, [946] = {
              key = "$MASTER_COND_0084"
          ,   en  = "Deliver the Concoction"
...
, [947] = {
              key = "$MASTER_COND_0085"
          ,   en  = "Deliver the Jewelry"
          ,   de  = "Liefert den Schmuck aus"
          ,   fr  = "Livrez le bijou"
          ,   es  = "Entrega la joya"
          ,   ru  = "Доставить ювелирное изделие"
          ,   ja  = "宝飾を届ける"
          }
, [948] = {
              key = "$MASTER_COND_0086"
          ,   en  = "Deliver the Weapon"
...
, [949] = {
              key = "$MASTER_COND_0087"
          ,   en  = "Deliver the Feast"
          ,   de  = "Liefert das Mahl"
          ,   fr  = "Livrer le festin."
...
, [950] = {
              key = "$MASTER_COND_0088"
          ,   en  = "Deliver the Armor"
...
, [951] = {
              key = "$MASTER_COND_0089"
          ,   en  = "Deliver the Glyph"
...
, [954] = {
          ...
          ,   fr  = "Fabriquez un casque en cuprite avec les caractéristiques suivantes : \n• Qualité : Épique\n• Trait : Divins\n• Ensemble : la Rétribution de Blancserpent\n• Style : Impérial\n• Progression : 0/1"
...
, [961] = {
              key = "$MASTER_COND_DELIVER_WEAPON"
          ,   en  = "Deliver the Weapon"
          ,   de  = "Liefert die Waffe"
          ,   fr  = "Livrer l'arme."
          ,   es  = "Entrega el arma"
...
, [987] = {
          ...
          ,   fr  = "• Ensemble : la Rétribution de Blancserpent"
          ,   es  = "• Conjunto: Castigo de Descarga Blanca"
...
, [1047] = {
          ...
          ,   fr  = "Je dois préparer les objets mentionnés par mon contrat."
...
, [1063] = {
              key = "$MATERIAL_AL_023266B"
          ,   en  = "filtered water"
          ,   de  = "gefiltertes Wasser"
          ,   fr  = "eau filtrée"
          ,   es  = "agua filtrada"
          ,   ru  = "фильтрованную воду"
          ,   ja  = "ろ過水"
          }
, [1064] = {
...
, [1087] = {
          ...
          ,   en  = "Lorkhan's Tears"
          ,   de  = "Lorkhans Tränen"
          ,   fr  = "larmes de Lorkhan"
          ,   es  = "Lágrimas de Lorkhan"
          ,   ru  = "Слезы Лорхана"
          ,   ja  = "ロルカーンの涙"
          }
, [1088] = {
...
, [1097] = {
          ...
          ,   fr  = "thorax de flammouche"
          ,   es  = "tórax de luciérnaga"
          ,   ru  = "Торакс светлячка"
          ,   ja  = "ホタルの腹部"
          }
, [1098] = {
          ...
          ,   en  = "Beetle Scuttle"
          ,   de  = "Käferbeine"
          ,   fr  = "cloaque de scarabée"
          ,   es  = "baba de escarabajo"
          ,   ru  = "Жучиный скатл"
          ,   ja  = "ビートルスカトル"
          }
, [1099] = {
...
, [1101] = {
          ...
          ,   fr  = "larve de mouche à viande"
          ,   es  = "larva de mosca de la carne"
...
, [1104] = {
          ...
          ,   fr  = "chitine de vasard"
          ,   es  = "quitina de cangrejo del barro"
...
, [1311] = {
              key = "$QUEST_OFFERED_ACCEPT_1"
          ,   en  = "<Accept the contract.>"
          ,   de  = "<Nehmt den Auftrag an.>"
          ,   fr  = "<Accepter le contrat>"
          ,   es  = "<Aceptar el contrato.>"
          ,   ru  = "<Принять заказ.>"
          ,   ja  = "<契約を受諾する>"
          }
, [1312] = {
              key = "$QUEST_OFFERED_ACCEPT_2"
          ,   en  = "<Accept the contract.>"
          ,   de  = "<Den Auftrag annehmen.>"
          ,   fr  = "<Accepter le contrat.>"
          ,   es  = "<Aceptar el contrato.>"
          ,   ru  = "<Принять заказ.>"
          ,   ja  = "<契約を受諾する>"
...
, [1313] = {
              key = "$QUEST_OFFERED_TITLE_AL"
          ,   en  = "-Sealed Alchemy Writ-"
          ,   de  = "-Versiegelter Alchemieschrieb-"
          ,   fr  = "-Commande scellée d'alchimie-"
          ,   es  = "-Encargo de alquimia sellado-"
          ,   ru  = "-Запечатанный заказ алхимику-"
          ,   ja  = "-密封された錬金術依頼-"
          }
, [1314] = {
              key = "$QUEST_OFFERED_TITLE_BS"
          ,   en  = "-Sealed Blacksmithing Writ-"
          ,   de  = "-Versiegelter Waffenschmiedeschrieb-"
          ,   fr  = "-Commande de forge scellée-"
          ,   es  = "-Encargo de herrería sellado-"
          ,   ru  = "-Запечатанный заказ кузнецу-"
          ,   ja  = "-密封された鍛冶依頼-"
          }
, [1315] = {
              key = "$QUEST_OFFERED_TITLE_CL"
          ,   en  = "-Sealed Clothier Writ-"
          ,   de  = "-Versiegelter Schneiderschrieb-"
          ,   fr  = "-Commande scellée de couture-"
          ,   es  = "-Encargo de sastrería sellado-"
          ,   ru  = "-Запечатанный заказ портному-"
          ,   ja  = "-密封された仕立依頼-"
          }
, [1316] = {
              key = "$QUEST_OFFERED_TITLE_EN"
          ,   en  = "-Sealed Enchanting Writ-"
          ,   de  = "-Versiegelter Verzauberungsschrieb-"
          ,   fr  = "-Commande d'enchantement scellée-"
          ,   es  = "-Encargo de encantamiento sellado-"
          ,   ru  = "-Запечатанный заказ зачарователю-"
          ,   ja  = "-密封された付呪依頼-"
          }
, [1317] = {
              key = "$QUEST_OFFERED_TITLE_JW"
          ,   en  = "-Sealed Jewelry Crafter Writ-"
          ,   de  = "-Versiegelter Schmuckhandwerksschrieb-"
          ,   fr  = "-Commande scellée de joaillier-"
          ,   es  = "-Encargo de joyería sellado-"
          ,   ru  = "-Запечатанный заказ ювелиру-"
          ,   ja  = "-密封された宝飾師依頼-"
          }
, [1318] = {
              key = "$QUEST_OFFERED_TITLE_PR"
          ,   en  = "-Sealed Provisioning Writ-"
          ,   de  = "-Versiegelter Versorgerschrieb-"
          ,   fr  = "-Commande scellée de cuisine-"
          ,   es  = " -Encargo de cocina sellado-"
          ,   ru  = "-Запечатанный заказ снабженцу-"
          ,   ja  = "-密封された調理依頼-"
          }
, [1319] = {
              key = "$QUEST_OFFERED_TITLE_WW"
          ,   en  = "-Sealed Woodworking Writ-"
          ,   de  = "-Versiegelter Schreinerschrieb-"
          ,   fr  = "-Commande de travail du bois scellée-"
          ,   es  = "-Encargo de carpintería sellado-"
          ,   ru  = "-Запечатанный заказ столяру-"
          ,   ja  = "-密封された木工依頼-"
          }
, [1320] = {
