...
LibCraftText.ALCHEMY_SOLVENT = {
  { rank=1, name="sip"                    , mat=cm.NATURAL_WATER  }
, { rank=2, name="tincture"               , mat=cm.CLEAR_WATER    }
, { rank=3, name="dram"                   , mat=cm.PRISTINE_WATER }
...
, { rank=8, name="distillate"             , mat=cm.STAR_DEW       }
